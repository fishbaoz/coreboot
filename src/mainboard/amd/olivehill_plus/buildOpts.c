...
#define BLDCFG_UMA_ALIGNMENT                      UMA_4MB_ALIGNED
 ...
 #define BLDCFG_UMA_ALLOCATION_SIZE                (CONFIG_UMA_ALLOCATION_SIZE >> 16)
...
GPIO_CONTROL   olivehill_plus_gpio[] = {
	{183, Function1, GpioIn | GpioOutEnB | PullUpB},
	{-1}
};
//#define BLDCFG_FCH_GPIO_CONTROL_LIST           (&olivehill_plus_gpio[0])
