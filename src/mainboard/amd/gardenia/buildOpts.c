...
#define BLDOPT_REMOVE_SRAT                     TRUE
#define BLDOPT_REMOVE_SLIT                     TRUE
#define BLDOPT_REMOVE_S3_SUPPORT               FALSE
...
GPIO_CONTROL   gardenia_gpio[] = {
	{3, Function2, /* GpioIn | GpioOutEnB | PullUpB */0x84},
	{4, Function1, /* GpioIn | GpioOutEnB | PullUpB */0x84},
	{5, Function1, /* GpioIn | GpioOutEnB | PullUpB */0xC5},
	{-1}
};
#define BLDCFG_FCH_GPIO_CONTROL_LIST           (&gardenia_gpio[0])
...
//    MEMCLK_DIS_MAP (ANY_SOCKET, ANY_CHANNEL, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0),
  MEMCLK_DIS_MAP (ANY_SOCKET, ANY_SOCKET, 0x01, 0x02, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00),
  //MEMCLK_DIS_MAP (ANY_SOCKET, CHANNEL_B, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00),

  CKE_TRI_MAP (ANY_SOCKET, ANY_CHANNEL, 0x01, 0x02, 0x4, 0x8), /* TODO: bit2map, bit3map */
  ...
  #if 0
  MEMCLK_DIS_MAP (ANY_SOCKET, CHANNEL_A, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
  ...
  CKE_TRI_MAP (ANY_SOCKET, CHANNEL_B, 0x05, 0x0C, 0x00, 0x00),
  ODT_TRI_MAP (ANY_SOCKET, CHANNEL_A, 0x01, 0x04, 0x00, 0x00),
  ODT_TRI_MAP (ANY_SOCKET, CHANNEL_B, 0x01, 0x04, 0x02, 0x08),
  CS_TRI_MAP (ANY_SOCKET, CHANNEL_A, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
