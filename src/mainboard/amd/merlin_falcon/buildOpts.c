...
#define BLDCFG_VRM_SLEW_RATE                    12000
#define BLDCFG_VRM_NB_CURRENT_LIMIT             12000
...
#define BLDCFG_VRM_GFX_CURRENT_LIMIT            30000
#define BLDCFG_VRM_GFX_MAXIMUM_CURRENT_LIMIT    45000
#define BLDCFG_VRM_GFX_SVI_OCP_LEVEL            BLDCFG_VRM_GFX_MAXIMUM_CURRENT_LIMIT
#define BLDCFG_VRM_GFX_LOW_POWER_THRESHOLD      15000
#define BLDCFG_VRM_GFX_SLEW_RATE                10000
...
#define BLDCFG_MEMORY_QUAD_RANK_CAPABLE           FALSE //TRUE
...
#define BLDCFG_BANK_SWIZZLE                       FALSE //TRUE
#define BLDCFG_TIMING_MODE_SELECT                 TIMING_MODE_AUTO
#define BLDCFG_MEMORY_CLOCK_SELECT                DDR2133_FREQUENCY
#define BLDCFG_DQS_TRAINING_CONTROL               FALSE //TRUE
...
#define BLDCFG_UMA_VERSION                        UMA_LEGACY
...
#define BLDCFG_CFG_GNB_HD_AUDIO                   TRUE //FALSE
...
#define DFLT_AZALIA_SSID                    0x157A1022
#define DFLT_SMBUS_SSID                     0x790B1022
#define DFLT_IDE_SSID                       0x790C1022
#define DFLT_SATA_AHCI_SSID                 0x79011022
#define DFLT_SATA_IDE_SSID                  0x79001022
#define DFLT_SATA_RAID5_SSID                0x79031022
#define DFLT_SATA_RAID_SSID                 0x79021022
#define DFLT_EHCI_SSID                      0x79081022
#define DFLT_OHCI_SSID                      0x79071022
#define DFLT_LPC_SSID                       0x790E1022
#define DFLT_SD_SSID                        0x79061022
#define DFLT_XHCI_SSID                      0x79121022
...
GPIO_CONTROL   merlin_falcon_gpio[] = {
...
#ifndef __PRE_RAM__
UINT32 AzaliaCodecAlc272Table[] = {
0x00172072, 0x00172102, 0x001722EC, 0x00172310,
0x02050002, 0x0204A2A0, 0x02050003, 0x02044843,
...
0x01A71C30, 0x01A71D30, 0x01A71E81, 0x01A71F01,
0x01B71CF0, 0x01B71D11, 0x01B71E11, 0x01B71F41,
0x01D71C05, 0x01D71D1E, 0x01D71E35, 0x01D71F40,
0x01E71C20, 0x01E71D01, 0x01E71E46, 0x01E71F90,
0x02171C10, 0x02171D40, 0x02171E21, 0x02171F01,
0x0205000D, 0x02044050, 0x02050003, 0x02044003,
0xffffffff
};
#define BLDCFG_CODEC_ID                          0x10ec0272ul  // Realtek ALC288 Vendor ID=10ECh, Device ID=0288h

CODEC_VERB_TABLE_LIST OemCodecTableList[] =
{
	{ (UINT32) BLDCFG_CODEC_ID, (UINT32)(&AzaliaCodecAlc272Table[0])},
	{ (UINT32) 0x0FFFFFFFFul, (UINT32)0x0FFFFFFFFul}
};

#define BLDCFG_CODEC_VERB_TABLE                  &OemCodecTableList
#endif
...
//	WRITE_LEVELING_SEED (ANY_SOCKET, CHANNEL_B, ALL_DIMMS,
//			     0x15, 0x15, 0x15, 0x15, 0x15, 0x15, 0x15, 0x15, 0x15),
  ...
  //NUMBER_OF_DIMMS_SUPPORTED (ANY_SOCKET, CHANNEL_B, 2),
  NUMBER_OF_CHANNELS_SUPPORTED (ANY_SOCKET, 2),
  MOTHER_BOARD_LAYERS (LAYERS_6),

//  MEMCLK_DIS_MAP (ANY_SOCKET, ANY_CHANNEL, 0x04, 0x01, 0x02, 0x08, 0x00, 0x00, 0x00, 0x00),
//  MEMCLK_DIS_MAP (ANY_SOCKET, ANY_CHANNEL, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff),
//    MEMCLK_DIS_MAP (ANY_SOCKET, ANY_CHANNEL, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0),
#if 0
  MEMCLK_DIS_MAP (ANY_SOCKET, ANY_SOCKET, 0x02, 0x04, 0x01, 0x08, 0x00, 0x00, 0x00, 0x00),
  //MEMCLK_DIS_MAP (ANY_SOCKET, CHANNEL_B, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00),

  CKE_TRI_MAP (ANY_SOCKET, ANY_CHANNEL, 0x05, 0x0A, 0x0, 0x0), /* TODO: bit2map, bit3map */
...
#else
  MEMCLK_DIS_MAP (ANY_SOCKET, ANY_SOCKET, 0x0F, 0x0F, 0x0f, 0x0f, 0x00, 0x00, 0x00, 0x00),
  CKE_TRI_MAP (ANY_SOCKET, ANY_CHANNEL, 0x0f, 0x0f, 0xf, 0xf), /* TODO: bit2map, bit3map */
  ODT_TRI_MAP (ANY_SOCKET, ANY_CHANNEL, 0x0f, 0x0f, 0x0f, 0xf),
  CS_TRI_MAP (ANY_SOCKET, ANY_CHANNEL, 0x0f, 0x0f, 0x0f, 0x0f, 0x00, 0x00, 0x00, 0x00),
#endif
  PSO_END
};
