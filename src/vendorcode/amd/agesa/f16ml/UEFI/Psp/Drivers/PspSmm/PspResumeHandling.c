 ...
 * @e project:      AGESA
 * @e sub-project:  PSP
 * @e \$Revision: 289207 $   @e \$Date: 2014-04-07 16:20:22 -0500 (Mon, 07 Apr 2014) $
 */
/*****************************************************************************
 *
  ...
  )
{
  ...
  if (++ApExitS3Count >= (mSmst->NumberOfCpus)) {
    ApExitS3Count = 0;
    PciAddress.AddressValue = MAKE_SBDFO (0, 0, 0x18, 5, 0x204);
    do {
      PspMboxBiosClearS3Status ();
      PspLibPciRead (AccessWidth32, PciAddress, &S0i3Ctrl);
