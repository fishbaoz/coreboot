...
#Version 1.1.5  Fill the entry size in PSP directory with its MAX size when recovery mode specified
Version = "1.1.5"
BiosList = []
PspList = []
...
#                         Type: IsFix MaxSize  ShortName    Full description
                          ...
                          0x02: [ 0, 0x035000,  'PspOs','PSP Secure OS firmware'],
                          0x03: [ 1, 0x00A000,  'PspRecBL','PSP Recovery Boot Loader'],
                          0x04: [ 1, 0x008000,  'PspNv','PSP Non Volatile data'],
                          0x05: [ 1, 0x000340,  'OemPubKey','[OEM] BIOS public key signed with AMD key'],
                          0x06: [ 0, 0x000000,  'Rtm','BIOS RTM Volume'],
                          0x07: [ 0, 0x000100,  'RtmSignature','BIOS RTM volume Signature using OEM private key'],
                          0x08: [ 0, 0x020100,  'Smu','SMU offchip firmware'],
                          ...
                          0x13: [ 0, 0x00A000,  'PspEsud','PSP early secure unlock debug image'],
