 ...
 * @e project:     AGESA
 * @e sub-project: FCH
 * @e \$Revision: 291181 $   @e \$Date: 2014-04-29 10:01:34 -0500 (Tue, 29 Apr 2014) $
 *
 */
/*
*****************************************************************************
...
//  {0x003625C2, 4 << 20, 4096,  33, 104, 168, 432, 0x05, 0x01, 0x1, 0x0040}, //Macronix_MX25U3235F
  ...
  {0x00164001, 4 << 20, 4096,  50, 108, 216, 432, 0x35, 0x01, 0x1, 0x0002}, //S25FL132K
  {0x00174001, 8 << 20, 4096,  50, 108, 216, 432, 0x35, 0x01, 0x1, 0x0002}, //S25FL132K
  ...
  )
{
  ...
  case 0x17BB20://N25Q064A11
  case 0x16BB20://N25Q032A11
  case 0x20://All Micron
  ...
  )
{
  ...
  if (( SpiMode !=  LocalCfgPtr->Spi.SpiMode) || ( SpiFastSpeed !=  (LocalCfgPtr->Spi.SpiFastSpeed -1))) {
    if (FchPlatformSpiQe (FchDataPtr)) {
      ...
      FlashWriteAddress = RomSigStartingAddr - RomBase + 0x40;
      FchSpiTransfer (
        0x06, //IN  UINT8    PrefixCode,
        0x02,//IN  UINT8    Opcode,
      ...
      //  0x06, //IN  UINT8    PrefixCode,
      //  0x02,//IN  UINT8    Opcode,
      //  (UINT8 *) (UINTN) (&DeviceID),//IN  OUT UINT8    *DataPtr,
      //  (UINT8 *)FlashWriteAddress,//IN  UINT8    *AddressPtr,
      //  3,//IN  UINT8    Length,
      //  1,//IN  BOOLEAN  WriteFlag,
      //  1,//IN  BOOLEAN  AddressFlag,
