...
FCH_DATA_BLOCK   InitEnvCfgDefault = {
  ...
  {                          // FCH_USB
    ...
    0,                                   // Ehci3DebugPortSel
    {
      {0xff, 0xff, 0xff, 0xff, 0xff},    // FchUsbOc USB1
      {0xff, 0xff, 0xff, 0xff, 0xff},    // FchUsbOc USB2
      {0xff, 0xff, 0xff, 0xff},          // FchUsbOc USB3
      {0xff, 0xff},                      // FchUsbOc USB4
      {0xff, 0xff},                      // FchUsbOc XHCI0
      {0xff, 0xff}                       // FchUsbOc XHCI1
    }
  },
