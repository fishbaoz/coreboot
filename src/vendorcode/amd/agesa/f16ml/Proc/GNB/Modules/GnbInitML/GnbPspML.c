 ...
 * @e project:     AGESA
 * @e sub-project: GNB
 * @e \$Revision: 290861 $   @e \$Date: 2014-04-25 17:12:31 -0500 (Fri, 25 Apr 2014) $
 *
 */
/*
*****************************************************************************
 ...
 *
 *
 * @param[in]  PspFwVersion Pointer to UINT32 value from PSP Mailbox
 * @param[in]  GnbHandle  GNB_HANDLE
 * @param[in]  StdHeader  Standard configuration header
 * @retval     AGESA_STATUS
 */
  ...
  )
{
  ...
  /// Read PSP fw version
  GnbLibMemRead (PSP_BAR1_TMP_BASE + PSP_FW_VERSION, AccessWidth32, PspFwVersion, StdHeader);
