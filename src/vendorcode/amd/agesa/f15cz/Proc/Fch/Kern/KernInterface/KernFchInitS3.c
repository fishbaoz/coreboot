...
#include "KernFchTaskLauncher.h"
#define FILECODE PROC_FCH_KERN_KERNINTERFACE_KERNFCHINITS3_FILECODE
  ...
  )
{
  ...
  FchTaskLauncher (&FchInitS3EarlyTaskTable[0], FchDataPtr, TpFchInitS3EarlyDispatching);
...
{
  FchDataPtr->Misc.S3Resume = 1;
  FchTaskLauncher (&FchInitS3LateTaskTable[0], FchDataPtr, TpFchInitS3LateDispatching);
  FchDataPtr->Misc.S3Resume = 0;
}
