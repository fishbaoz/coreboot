...
#define FILECODE PROC_FCH_KERN_KERNSPI_KERNSPIENV_FILECODE
#define SPI_BASE UserOptions.FchBldCfg->CfgSpiRomBaseAddress

#define QEENABLE_ON 1
#if QEENABLE_ON // TODO: See comments near end of file
  ...
  )
{
  ...
  /* AGESA has several problems with the SPI ROM Quad I/O mode.
