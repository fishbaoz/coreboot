...
#define FILECODE PROC_FCH_KERN_KERNIR_KERNIRENV_FILECODE
  ...
  )
{
  ...
  if ((FchIrConfig == IrRxTx0) || (FchIrConfig == IrRxTx0Tx1)) {
    ACPIMMIO8 (FCH_IOMUXx0D_IR_TX0_USB_OC5_L_AGPIO13) = 0;
  }
  if ((FchIrConfig == IrRxTx1) || (FchIrConfig == IrRxTx0Tx1)) {
    ACPIMMIO8 (FCH_IOMUXx0E_IR_TX1_USB_OC6_L_AGPIO14) = 0;
  }
