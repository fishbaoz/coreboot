...
#include "amdlib.h"
#include "Filecode.h"
#define FILECODE PROC_FCH_KERN_KERNHWACPI_KERNHWACPIENV_FILECODE
  ...
  )
{
  ...
  ACPIMMIO8 (FCH_IOMUXx71_SCL0_I2C2_SCL_EGPIO113) = LocalCfgPtr->IoMux.CbsDbgFchSmbusI2c2Egpio;
  ACPIMMIO8 (FCH_IOMUXx72_SDA0_I2C2_SDA_EGPIO114) = LocalCfgPtr->IoMux.CbsDbgFchSmbusI2c2Egpio;
  ACPIMMIO8 (FCH_IOMUXx13_SCL1_I2C3_SCL_EGPIO19) = LocalCfgPtr->IoMux.CbsDbgFchAsfI2c3Egpio;
  ACPIMMIO8 (FCH_IOMUXx14_SDA1_I2C3_SDA_EGPIO20) = LocalCfgPtr->IoMux.CbsDbgFchAsfI2c3Egpio;
  //Configure UART PINs
  ACPIMMIO8 (FCH_IOMUXx89_UART0_RTS_L_EGPIO137) = 0;
  ACPIMMIO8 (FCH_IOMUXx8A_UART0_TXD_EGPIO138) = 0;
  ACPIMMIO8 (FCH_IOMUXx8E_UART1_RTS_L_EGPIO142) = 0;
  ACPIMMIO8 (FCH_IOMUXx8F_UART1_TXD_EGPIO143) = 0;

  if (LocalCfgPtr->PostOemGpioTable != NULL) {
    ProgramFchGpioTbl ((GPIO_CONTROL  *) (LocalCfgPtr->PostOemGpioTable));
  }
}
