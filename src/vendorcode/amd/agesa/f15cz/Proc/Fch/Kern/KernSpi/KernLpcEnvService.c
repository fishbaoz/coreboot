...
#include "Filecode.h"
#define FILECODE PROC_FCH_KERN_KERNSPI_KERNLPCENVSERVICE_FILECODE

/**
 * FchInitKernEnvLpcPciTable - PCI device registers initial
 * during early POST.
 *
 */
REG8_MASK FchInitKernEnvLpcPciTable[] =
{
  //
  ...
  )
{
  ...
  ProgramPciByteTable ((REG8_MASK*) (&FchInitKernEnvLpcPciTable[0]), sizeof (FchInitKernEnvLpcPciTable) / sizeof (REG8_MASK), StdHeader);
