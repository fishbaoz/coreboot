...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_GFXPOSTINITST_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GfxPostInterfaceST Enter\n");
  GnbHandle = GnbGetHandle (StdHeader);
  ASSERT (GnbHandle != NULL);
  GnbRegisterReadST (GnbHandle, D0F0xBC_xC0014000_TYPE,
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GfxPostInterfaceST Exit [0x%x]\n", Status);
  return  Status;
}
