...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_PCIELIBST_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePowerDownPllInL1ST Enter\n");
  ...
  if (ActiveLaneBitmap != 0) {
    PllPowerUpLatency = PciePifGetPllPowerUpLatencyST (Wrapper, Pcie);
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePowerDownPllInL1ST Exit\n");
}
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieSetVoltageST Enter\n");
  Index = 0;

  PpFuseArray = GnbLocateHeapBuffer (AMD_PP_FUSE_TABLE_HANDLE, GnbLibGetHeader (Pcie));
  if (PpFuseArray == NULL) {
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC0014004_TYPE, D0F0xBC_xC0014004_ADDRESS, &D0F0xBC_xC0014004, 0, GnbLibGetHeader (Pcie));
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC0014007_TYPE, D0F0xBC_xC0014007_ADDRESS, &D0F0xBC_xC0014007, 0, GnbLibGetHeader (Pcie));
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC0014008_TYPE, D0F0xBC_xC0014008_ADDRESS, &D0F0xBC_xC0014008, 0, GnbLibGetHeader (Pcie));
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC00160C4_TYPE, D0F0xBC_xC00160C4_ADDRESS, &D0F0xBC_xC00160C4, 0, GnbLibGetHeader (Pcie));
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC00160C7_TYPE, D0F0xBC_xC00160C7_ADDRESS, &D0F0xBC_xC00160C7, 0, GnbLibGetHeader (Pcie));
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC00160C8_TYPE, D0F0xBC_xC00160C8_ADDRESS, &D0F0xBC_xC00160C8, 0, GnbLibGetHeader (Pcie));
    GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), D0F0xBC_xC001706C_TYPE, D0F0xBC_xC001706C_ADDRESS, &D0F0xBC_xC001706C, 0, GnbLibGetHeader (Pcie));
  ...
  if (TargetVid != 0) {
    GnbRegisterWriteST (GnbGetHandle (GnbLibGetHeader (Pcie)), TYPE_SMU_MSG, SMC_MSG_VddNbRequest, Millivolt, 0, GnbLibGetHeader (Pcie));
  }
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieSetVoltageST Exit\n");
}
    ...
    )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieTopologyLaneControlST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieTopologyLaneControlST Exit\n");
}
...
VOID
PciePwrPowerDownUnusedLanesST (
  IN       PCIe_WRAPPER_CONFIG    *Wrapper,
  IN       PCIe_PLATFORM_CONFIG   *Pcie
  )
{
  UINT32              UnusedLanes;
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePwrPowerDownUnusedLanesST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePwrPowerDownUnusedLanesST Exit\n");
}
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "DdiEdpPortDetectCallbackST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "DdiEdpPortDetectCallbackST Exit\n");
}
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieEdpPortPowerCheckST Enter\n");
  ...
  if (Status == AGESA_SUCCESS) {
    ...
    if (EdpPresent == FALSE) {
      // Power off
      GnbRegisterReadST (GnbGetHandle (GnbLibGetHeader (Pcie)), GMMx1206C_TYPE, GMMx1206C_ADDRESS, &GMMx1206C.Value, 0, GnbLibGetHeader (Pcie));
      GMMx1206C.Field.LVTMA_PWRSEQ_EN = 0;
      GMMx1206C.Field.LVTMA_PWRSEQ_TARGET_STATE = 0;
      GMMx1206C.Field.LVTMA_BLON_OVRD = 0;
      GnbRegisterWriteST (GnbGetHandle (GnbLibGetHeader (Pcie)), GMMx1206C_TYPE, GMMx1206C_ADDRESS, &GMMx1206C.Value, GNB_REG_ACC_FLAG_S3SAVE, GnbLibGetHeader (Pcie));
    }
  }
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieMidBeforeGfxInitST Exit [0x%x]\n", AgesaStatus);
  return  AgesaStatus;
}
