...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_PCIEPOWERGATEST_FILECODE
/*----------------------------------------------------------------------------------------
...
AGESA_STATUS
STATIC
PciePowerGatePowerDownUnusedLanesCallbackST (
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePowerGatePowerDownUnusedLanesCallbackST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePowerGatePowerDownUnusedLanesCallbackST Exit\n");
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePowerGateST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PciePowerGateST Exit\n");
  return  AGESA_SUCCESS;
}
