...
#include  "heapManager.h"
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_GNBBOOTTIMECALST_FILECODE
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GnbBootTimeCalInterfaceST Enter\n");
  ...
  GnbRegisterReadST (GnbGetHandle (StdHeader), TYPE_D0F0xBC, 0xC0016078,
  ...
  BtcGetSetGbvST (GnbHandle, GNB_REG_ACC_FLAG_S3SAVE, StdHeader);
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GnbBootTimeCalInterfaceST Exit [0x%x]\n", AgesaStatus);
  return  AgesaStatus;
}
