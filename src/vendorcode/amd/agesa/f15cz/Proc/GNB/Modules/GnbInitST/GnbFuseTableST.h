...
*
*/
#ifndef _GNBFUSETABLEST_H_
#define _GNBFUSETABLEST_H_
...
typedef struct {
  ...
  FUSE_REGISTER_ENTRY_ST   *FuseRegisterTable;       ///< Pointer to field table
} FUSE_TABLE_ENTRY_ST;

/// Fuse translation table
typedef struct {
  UINT8                    FuseTableLength;          ///< Length of translation table
  FUSE_TABLE_ENTRY_ST      *FuseTable;               ///< Pointer to register table
} FUSE_TABLE_ST;
