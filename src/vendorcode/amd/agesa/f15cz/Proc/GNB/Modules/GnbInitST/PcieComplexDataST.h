...
*
*/
#ifndef _PCIECOMPLEXDATAST_H_
#define _PCIECOMPLEXDATAST_H_
...
#define NUMBER_OF_PORTS          NUMBER_OF_GPP_PORTS

#define NUMBER_OF_WRAPPERS        1
...
typedef struct {
  ...
  ST_PCIe_SILICON_CONFIG  FmSilicon;              ///< Fm silicon config
} ST_COMPLEX_CONFIG;
