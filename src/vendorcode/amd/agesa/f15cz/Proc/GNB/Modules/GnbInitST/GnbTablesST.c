...
GNB_TABLE ROMDATA GnbEarlierInitTableBeforeSmuST [] = {
  GNB_ENTRY_RMW (
    D0F0x98_x07_TYPE,
    D0F0x98_x07_ADDRESS,
...
GNB_TABLE ROMDATA GnbEarlyInitTableST [] = {
  GNB_ENTRY_RMW (
    D0F0x64_x16_TYPE,
    D0F0x64_x16_ADDRESS,
...
GNB_TABLE ROMDATA GnbEnvInitTableST [] = {
//---------------------------------------------------------------------------
// ORB Init
  GNB_ENTRY_RMW (
    D0F0x98_x06_TYPE,
...
//---------------------------------------------------------------------------
// Clump enable for unitID 5 10 21 22 23 for ST
  GNB_ENTRY_RMW (
    D0F0x98_x3A_TYPE,
    D0F0x98_x3A_ADDRESS,
    0xE00420,
...
GNB_TABLE ROMDATA GnbMidInitTableST [] = {
  //Lock mapping
  GNB_ENTRY_RMW (
    D9F2xF4_x0F_TYPE,
    D9F2xF4_x0F_ADDRESS,
