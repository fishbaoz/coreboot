...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_GNBPOSTINITST_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GnbPostInterfaceST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GnbPostInterfaceST Exit [0x%x]\n", AgesaStatus);
  return  AgesaStatus;
}
