...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_GNBREGISTERACCST_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  GNB_DEBUG_CODE (
    ...
    GnbRegisterWriteSTDump (RegisterSpaceType, TempAddress, Value);
  );
