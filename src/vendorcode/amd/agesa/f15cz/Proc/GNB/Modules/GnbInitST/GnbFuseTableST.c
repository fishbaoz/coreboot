...
#include  "GnbFuseTableST.h"
#include  "GnbRegistersST.h"
#include  "GnbRegisterAccST.h"
#include  "GnbHandleLib.h"
#include  "OptionGnb.h"
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_GNBFUSETABLEST_FILECODE
/*----------------------------------------------------------------------------------------
...
PP_FUSE_ARRAY_V2  DefaultPpFuseArrayST = {
    0,                              // PP table revision
    ...
    { 0, 0, 0, 0},                  // DRAM Controller Miscellaneous 2 [per DCT]- removed on ST
    ...
    4,                                //PcieGen3Vid
    { 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x24}, //GfxVid - new added for ST
    { 0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7},    // GfxVidOffset - new added for ST
};

FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0014004_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0014007_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0014008_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160C4_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160C7_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160C8_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160CB_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160CC_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160CF_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160D0_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160D3_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160D4_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160D7_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160D8_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160DC_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160F4_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160F7_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC00160F8_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001704C_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001706C_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001706F_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017070_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017074_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017077_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017078_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001707B_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001707C_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001707F_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017080_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017083_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017084_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017087_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017088_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017107_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017108_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001711C_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001711F_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017120_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001712C_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001712F_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017130_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017164_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC0017167_TABLE_ST [] = {
  {
...
FUSE_TABLE_ENTRY_ST  FuseRegisterTableST [] = {
  {
    D0F0xBC_xC0014004_TYPE,
    D0F0xBC_xC0014004_ADDRESS,
    sizeof (D0F0xBC_xC0014004_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0014004_TABLE_ST
  },
  {
    D0F0xBC_xC0014007_TYPE,
    D0F0xBC_xC0014007_ADDRESS,
    sizeof (D0F0xBC_xC0014007_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0014007_TABLE_ST
  },
  {
    D0F0xBC_xC0014008_TYPE,
    D0F0xBC_xC0014008_ADDRESS,
    sizeof (D0F0xBC_xC0014008_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0014008_TABLE_ST
  },
  {
    D0F0xBC_xC00160C4_TYPE,
    D0F0xBC_xC00160C4_ADDRESS,
    sizeof (D0F0xBC_xC00160C4_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160C4_TABLE_ST
  },
  {
    D0F0xBC_xC00160C7_TYPE,
    D0F0xBC_xC00160C7_ADDRESS,
    sizeof (D0F0xBC_xC00160C7_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160C7_TABLE_ST
  },
  {
    D0F0xBC_xC00160C8_TYPE,
    D0F0xBC_xC00160C8_ADDRESS,
    sizeof (D0F0xBC_xC00160C8_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160C8_TABLE_ST
  },
  {
    D0F0xBC_xC00160CB_TYPE,
    D0F0xBC_xC00160CB_ADDRESS,
    sizeof (D0F0xBC_xC00160CB_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160CB_TABLE_ST
  },
  {
    D0F0xBC_xC00160CC_TYPE,
    D0F0xBC_xC00160CC_ADDRESS,
    sizeof (D0F0xBC_xC00160CC_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160CC_TABLE_ST
  },
  {
    D0F0xBC_xC00160CF_TYPE,
    D0F0xBC_xC00160CF_ADDRESS,
    sizeof (D0F0xBC_xC00160CF_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160CF_TABLE_ST
  },
  {
    D0F0xBC_xC00160D0_TYPE,
    D0F0xBC_xC00160D0_ADDRESS,
    sizeof (D0F0xBC_xC00160D0_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160D0_TABLE_ST
  },
  {
    D0F0xBC_xC00160D3_TYPE,
    D0F0xBC_xC00160D3_ADDRESS,
    sizeof (D0F0xBC_xC00160D3_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160D3_TABLE_ST
  },
  {
    D0F0xBC_xC00160D4_TYPE,
    D0F0xBC_xC00160D4_ADDRESS,
    sizeof (D0F0xBC_xC00160D4_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160D4_TABLE_ST
  },
  {
    D0F0xBC_xC00160D7_TYPE,
    D0F0xBC_xC00160D7_ADDRESS,
    sizeof (D0F0xBC_xC00160D7_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160D7_TABLE_ST
  },
  {
    D0F0xBC_xC00160D8_TYPE,
    D0F0xBC_xC00160D8_ADDRESS,
    sizeof (D0F0xBC_xC00160D8_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160D8_TABLE_ST
  },
  {
    D0F0xBC_xC00160DC_TYPE,
    D0F0xBC_xC00160DC_ADDRESS,
    sizeof (D0F0xBC_xC00160DC_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160DC_TABLE_ST
  },
  {
    D0F0xBC_xC00160F4_TYPE,
    D0F0xBC_xC00160F4_ADDRESS,
    sizeof (D0F0xBC_xC00160F4_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160F4_TABLE_ST
  },
  {
    D0F0xBC_xC00160F7_TYPE,
    D0F0xBC_xC00160F7_ADDRESS,
    sizeof (D0F0xBC_xC00160F7_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160F7_TABLE_ST
  },
  {
    D0F0xBC_xC00160F8_TYPE,
    D0F0xBC_xC00160F8_ADDRESS,
    sizeof (D0F0xBC_xC00160F8_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC00160F8_TABLE_ST
  },
  {
    D0F0xBC_xC001704C_TYPE,
    D0F0xBC_xC001704C_ADDRESS,
    sizeof (D0F0xBC_xC001704C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001704C_TABLE_ST
  },
  {
    D0F0xBC_xC001706C_TYPE,
    D0F0xBC_xC001706C_ADDRESS,
    sizeof (D0F0xBC_xC001706C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001706C_TABLE_ST
  },
  {
    D0F0xBC_xC001706F_TYPE,
    D0F0xBC_xC001706F_ADDRESS,
    sizeof (D0F0xBC_xC001706F_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001706F_TABLE_ST
  },
  {
    D0F0xBC_xC0017070_TYPE,
    D0F0xBC_xC0017070_ADDRESS,
    sizeof (D0F0xBC_xC0017070_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017070_TABLE_ST
  },
  {
    D0F0xBC_xC0017074_TYPE,
    D0F0xBC_xC0017074_ADDRESS,
    sizeof (D0F0xBC_xC0017074_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017074_TABLE_ST
  },
  {
    D0F0xBC_xC0017077_TYPE,
    D0F0xBC_xC0017077_ADDRESS,
    sizeof (D0F0xBC_xC0017077_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017077_TABLE_ST
  },
  {
    D0F0xBC_xC0017078_TYPE,
    D0F0xBC_xC0017078_ADDRESS,
    sizeof (D0F0xBC_xC0017078_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017078_TABLE_ST
  },
  {
    D0F0xBC_xC001707B_TYPE,
    D0F0xBC_xC001707B_ADDRESS,
    sizeof (D0F0xBC_xC001707B_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001707B_TABLE_ST
  },
  {
    D0F0xBC_xC001707C_TYPE,
    D0F0xBC_xC001707C_ADDRESS,
    sizeof (D0F0xBC_xC001707C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001707C_TABLE_ST
  },
  {
    D0F0xBC_xC001707F_TYPE,
    D0F0xBC_xC001707F_ADDRESS,
    sizeof (D0F0xBC_xC001707F_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001707F_TABLE_ST
  },
  {
    D0F0xBC_xC0017080_TYPE,
    D0F0xBC_xC0017080_ADDRESS,
    sizeof (D0F0xBC_xC0017080_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017080_TABLE_ST
  },
  {
    D0F0xBC_xC0017083_TYPE,
    D0F0xBC_xC0017083_ADDRESS,
    sizeof (D0F0xBC_xC0017083_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017083_TABLE_ST
  },
  {
    D0F0xBC_xC0017084_TYPE,
    D0F0xBC_xC0017084_ADDRESS,
    sizeof (D0F0xBC_xC0017084_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017084_TABLE_ST
  },
  {
    D0F0xBC_xC0017087_TYPE,
    D0F0xBC_xC0017087_ADDRESS,
    sizeof (D0F0xBC_xC0017087_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017087_TABLE_ST
  },
  {
    D0F0xBC_xC0017088_TYPE,
    D0F0xBC_xC0017088_ADDRESS,
    sizeof (D0F0xBC_xC0017088_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017088_TABLE_ST
  },
  {
    D0F0xBC_xC0017107_TYPE,
    D0F0xBC_xC0017107_ADDRESS,
    sizeof (D0F0xBC_xC0017107_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017107_TABLE_ST
  },
  {
    D0F0xBC_xC0017108_TYPE,
    D0F0xBC_xC0017108_ADDRESS,
    sizeof (D0F0xBC_xC0017108_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017108_TABLE_ST
  },
  {
    D0F0xBC_xC001711C_TYPE,
    D0F0xBC_xC001711C_ADDRESS,
    sizeof (D0F0xBC_xC001711C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001711C_TABLE_ST
  },
  {
    D0F0xBC_xC001711F_TYPE,
    D0F0xBC_xC001711F_ADDRESS,
    sizeof (D0F0xBC_xC001711F_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001711F_TABLE_ST
  },
  {
    D0F0xBC_xC0017120_TYPE,
    D0F0xBC_xC0017120_ADDRESS,
    sizeof (D0F0xBC_xC0017120_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017120_TABLE_ST
  },
  {
    D0F0xBC_xC001712C_TYPE,
    D0F0xBC_xC001712C_ADDRESS,
    sizeof (D0F0xBC_xC001712C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001712C_TABLE_ST
  },
  {
    D0F0xBC_xC001712F_TYPE,
    D0F0xBC_xC001712F_ADDRESS,
    sizeof (D0F0xBC_xC001712F_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001712F_TABLE_ST
  },
  {
    D0F0xBC_xC0017130_TYPE,
    D0F0xBC_xC0017130_ADDRESS,
    sizeof (D0F0xBC_xC0017130_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017130_TABLE_ST
  },
  {
    D0F0xBC_xC0017164_TYPE,
    D0F0xBC_xC0017164_ADDRESS,
    sizeof (D0F0xBC_xC0017164_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017164_TABLE_ST
  },
  {
    D0F0xBC_xC0017167_TYPE,
    D0F0xBC_xC0017167_ADDRESS,
    sizeof (D0F0xBC_xC0017167_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC0017167_TABLE_ST
  }
};

FUSE_REGISTER_ENTRY_ST D18F3x64_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D0F0xBC_xC001400C_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F2x90_dct0_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F2x94_dct0_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F2x2E0_dct0_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F5x160_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F5x164_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F5x168_TABLE_ST [] = {
  {
...
FUSE_REGISTER_ENTRY_ST D18F5x16C_TABLE_ST [] = {
  {
...
FUSE_TABLE_ENTRY_ST  PPRegisterTableST [] = {
  {
    D18F3x64_TYPE,
    D18F3x64_ADDRESS,
    sizeof (D18F3x64_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F3x64_TABLE_ST
  },
  {
    D0F0xBC_xC001400C_TYPE,
    D0F0xBC_xC001400C_ADDRESS,
    sizeof (D0F0xBC_xC001400C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D0F0xBC_xC001400C_TABLE_ST
  },
  {
    D18F2x90_dct0_TYPE,
    D18F2x90_dct0_ADDRESS,
    sizeof (D18F2x90_dct0_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F2x90_dct0_TABLE_ST
  },
  {
    D18F2x94_dct0_TYPE,
    D18F2x94_dct0_ADDRESS,
    sizeof (D18F2x94_dct0_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F2x94_dct0_TABLE_ST
  },
  {
    D18F2x2E0_dct0_TYPE,
    D18F2x2E0_dct0_ADDRESS,
    sizeof (D18F2x2E0_dct0_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F2x2E0_dct0_TABLE_ST
  },
  {
    D18F5x160_TYPE,
    D18F5x160_ADDRESS,
    sizeof (D18F5x160_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F5x160_TABLE_ST
  },
  {
    D18F5x164_TYPE,
    D18F5x164_ADDRESS,
    sizeof (D18F5x164_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F5x164_TABLE_ST
  },
  {
    D18F5x168_TYPE,
    D18F5x168_ADDRESS,
    sizeof (D18F5x168_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F5x168_TABLE_ST
  },
  {
    D18F5x16C_TYPE,
    D18F5x16C_ADDRESS,
    sizeof (D18F5x16C_TABLE_ST) / sizeof (FUSE_REGISTER_ENTRY_ST),
    D18F5x16C_TABLE_ST
  }
};
...
FUSE_TABLE_ST  FuseTableST = {
  sizeof (FuseRegisterTableST) / sizeof (FUSE_TABLE_ENTRY_ST),
  FuseRegisterTableST
};


FUSE_TABLE_ST  PPTableST = {
  sizeof (PPRegisterTableST) / sizeof (FUSE_TABLE_ENTRY_ST),
  PPRegisterTableST
};
...
VOID
STATIC
NbFuseLoadFuseTableST (
  IN       FUSE_TABLE_ST       *FuseTable,
  ...
  )
{
  ...
  for (RegisterIndex = 0; RegisterIndex < FuseTable->FuseTableLength; RegisterIndex++ ) {
    ...
    for (FieldIndex = 0; FieldIndex < FuseRegisterTableLength;  FieldIndex++) {
      FUSE_REGISTER_ENTRY_ST   RegisterEntry;
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "GnbLoadFuseTableST Enter\n");
  ...
  if (PpFuseArray != NULL) {
    ...
    GnbRegisterReadST (GnbGetHandle (StdHeader), D0F0xBC_xD8230F00_TYPE, D0F0xBC_xD8230F00_ADDRESS, &D0F0xBC_xD8230F00.Value, 0, StdHeader);
    if ((D0F0xBC_xD8230F00.Field.COF_VID_PROG) && (GnbBuildOptions.GnbLoadRealFuseTable)) {
      NbFuseLoadFuseTableST (&FuseTableST, PpFuseArray, StdHeader);
      PpFuseArray->VceStateTableSupport = TRUE;
      IDS_HDT_CONSOLE (NB_MISC, "  Processor Fused\n");
    } else {
      LibAmdMemCopy (PpFuseArray, &DefaultPpFuseArrayST, sizeof (PP_FUSE_ARRAY_V2), StdHeader);
      IDS_HDT_CONSOLE (NB_MISC, "  Processor Unfuse\n");
    }
    NbFuseLoadFuseTableST (&PPTableST, PpFuseArray, StdHeader);
    IDS_OPTION_CALLOUT (IDS_CALLOUT_GNB_PPFUSE_OVERRIDE, PpFuseArray, StdHeader);
    GnbFuseTableDebugDumpST (PpFuseArray, StdHeader);
  } else {
    Status = AGESA_ERROR;
  }
  IDS_HDT_CONSOLE (GNB_TRACE, "GnbLoadFuseTableST Exit [0x%x]\n", Status);
  return Status;
}
