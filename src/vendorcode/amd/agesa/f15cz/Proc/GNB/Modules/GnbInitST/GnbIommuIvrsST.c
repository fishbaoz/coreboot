 ...
 * @e project:     AGESA
 * @e sub-project: GNB
 * @e \$Revision: 316103 $   @e \$Date: 2015-04-03 09:51:23 +0800 (Fri, 03 Apr 2015) $
 *
 */
/*
*****************************************************************************
...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_GNBIOMMUIVRSST_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  if (Type == IvrsIvhdBlock10h || Type == IvrsIvhdBlock11h || Type == IvrsIvhdrBlock40h || Type == IvrsIvhdrBlock41h) {
    ...
    if (Type == IvrsIvhdBlock10h || Type == IvrsIvhdrBlock40h) {
      GnbCreateIvhdHeader10hST (GnbHandle, Type, (IVRS_IVHD_ENTRY_10H*) Ivhd, StdHeader);
    }
    if (Type == IvrsIvhdBlock11h || Type == IvrsIvhdrBlock41h) {
      GnbCreateIvhdHeader11hST (GnbHandle, Type, (IVRS_IVHD_ENTRY_11H*) Ivhd, StdHeader);
    }
    GnbCreateIvhdST (GnbHandle, Ivhd, StdHeader);
