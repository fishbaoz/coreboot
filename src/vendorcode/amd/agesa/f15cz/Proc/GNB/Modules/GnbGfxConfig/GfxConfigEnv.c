  ...
  )
{
  ...
  if (Status == AGESA_SUCCESS) {
    ...
    Gfx->EDPv1_4VSMode = EnvParamsPtr->GnbEnvConfiguration.EDPv1_4VSMode;
    Gfx->ExtHDMIReDrvSlvAddr = EnvParamsPtr->GnbEnvConfiguration.ExtHDMIReDrvSlvAddr;
    Gfx->ExtHDMIReDrvRegNum = EnvParamsPtr->GnbEnvConfiguration.ExtHDMIReDrvRegNum;

    if (EnvParamsPtr->GnbEnvConfiguration.ExtHDMIRegSetting != NULL) {
      Gfx->ExtHDMIRegSetting = EnvParamsPtr->GnbEnvConfiguration.ExtHDMIRegSetting;
    }
