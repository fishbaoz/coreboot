...
#include  "Filecode.h"
#define FILECODE PROC_GNB_MODULES_GNBINITST_PCIEARIINITST_FILECODE
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "  PcieAriInitCallbackST for Device = %d:%d:%d\n",
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "  PcieAriInitCallbackST Exit\n");
}
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieAriInitST Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "PcieAriInitST Exit\n");
