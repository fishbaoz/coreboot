  ...
  )
{
  ...
  GnbEnvConfigPtr->EDPv1_4VSMode = UserOptions.CfgEDPv1_4VSMode;
  GnbEnvConfigPtr->ExtHDMIReDrvSlvAddr = UserOptions.CfgExtHDMIReDrvSlvAddr;
  GnbEnvConfigPtr->ExtHDMIReDrvRegNum = UserOptions.CfgExtHDMIReDrvRegNum;
  GnbEnvConfigPtr->ExtHDMIRegSetting = UserOptions.CfgExtHDMIRegSetting;
}
