...
#define CPU_FEAT_INIT_RTB_END             (0x0000000000000080ull)
#define CPU_FEAT_S3_FINAL_RESTORE         (0x0000000000000100ull)
#define CPU_FEAT_MID_INIT                 (0x0000000000000200ull)
#define CPU_FEAT_MID_LATE_INIT            (0x0000000000000400ull)
