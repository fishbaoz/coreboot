 ...
 * @e \$Revision: 310429 $   @e \$Date: 2015-01-06 01:48:16 -0600 (Tue, 06 Jan 2015) $
 *
 */
/*
 ******************************************************************************
...
/*---------------------------------------------------------------------------------------*/
/**
 *  Family specific call to program APM weights.
 *
 * @param[in]    ApmServices        APM services.
 * @param[in]    StdHeader          Config Handle for library, services.
 *
 ...
 *
 */
typedef AGESA_STATUS F_APM_WEIGHTS_INIT (
  IN       APM_FAMILY_SERVICES    *ApmServices,
  IN       AMD_CONFIG_PARAMS      *StdHeader
  );

/// Reference to a Method.
typedef F_APM_WEIGHTS_INIT *PF_APM_WEIGHTS_INIT;
...
struct _APM_FAMILY_SERVICES {
  ...
  PF_APM_WEIGHTS_INIT ProgramApmWeights;                                ///< Method: Family specific call to program APM weights.
  PF_APM_INIT         EnableApm;                                        ///< Method: Family specific call to enable APM.
};
