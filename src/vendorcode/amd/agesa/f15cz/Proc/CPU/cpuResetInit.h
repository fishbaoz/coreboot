...
#ifndef _CPU_RESET_INIT_H_
#define _CPU_RESET_INIT_H_
...
typedef struct {
  UINT64 :18;                        ///< Reserved
  UINT64 MtrrFixDramEn:1;            ///< Bit 18 MTRR fixed attributes enable
  UINT64 MtrrFixDramModEn:1;         ///< Bit 19 MTRR fixed modification enable
  UINT64 MtrrVarDramEn:1;            ///< Bit 20 MTRR variable enable
  UINT64 MtrrTom2En:1;               ///< Bit 21 MTRR top of memory2 enable
  UINT64 MtrrTom2ForceMemTypeWB:1;   ///< bIT 22 MTRR top of memory2 type WB
  UINT64 :40;                        ///< Reserved
} SYS_CFG_MSR;
