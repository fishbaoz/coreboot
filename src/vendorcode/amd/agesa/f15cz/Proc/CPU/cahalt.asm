...
ExecuteFinalHltInstruction PROC NEAR C USES ESI EDI HaltFlags:DWORD, ApMtrrSettingList:PTR, StandardHeader:PTR
  ...
  ; esi bit16 = 0 -> Ap communication by Local APIC
  ; esi bit16 = 1 -> Ap communication by PCI
...
EFLoop:
  ...
  ; ebx bit16 = 0 -> Ap communication by Local APIC
  ; ebx bit16 = 1 -> Ap communication by PCI
  .if (ebx & 10000h)
      AMD_DISABLE_STACK_FAMILY_HOOK AP_COMM_PCI
  .else
