 ...
 * @e project:      AGESA
 * @e sub-project:  CPU
 * @e \$Revision: 314217 $   @e \$Date: 2015-03-06 14:56:17 +0800 (Fri, 06 Mar 2015) $
 *
 */
/*
 ******************************************************************************
  ...
  )
{
  ...
  LibAmdMsrRead (0xC001101C, &MsrData, StdHeader);
  MsrData |= (1 << 17);
  LibAmdMsrWrite (0xC001101C, &MsrData, StdHeader);
  ...
  )
{
  ...
  TaskPtr.FuncAddress.PfApTask = LoadMicrocodePatch;
  ...
  )
{
  ...
  LibAmdMsrRead (0xc001101c, &myMsr, StdHeader);
  myMsr |= 1 << 17;
  LibAmdMsrWrite (0xc001101c, &myMsr, StdHeader);
