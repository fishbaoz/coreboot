 ...
 * @file
 *
 * AMD DMI Record Creation API, and related functions for Family15h Carrizo.
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_CZ_CPUF15CZDMI_FILECODE
  ...
  )
{
  ...
  case CZ_SOCKET_FP4:
    DmiStringTable = (CONST VOID *) &F15CzFP4T4ProcFamily[0];
    NumberOfDmiString = sizeof (F15CzFP4T4ProcFamily) / sizeof (CPU_T4_PROC_FAMILY);
    break;
  default:
    DmiStringTable = NULL;
    NumberOfDmiString = 0;
...
CONST PROC_FAMILY_TABLE ROMDATA ProcFamily15CzDmiTable =
{
// This table is for Processor family 15h Carrizo
  AMD_FAMILY_15_CZ,               // ID for Family 15h Carrizo
  DmiF15CzGetInfo,                // Transfer vectors for family
  DmiF15CzGetT4ProcFamily,        // Get type 4 processor family information
  DmiF15CzGetVoltage,             //   specific routines (above)
  DmiF15GetMaxSpeed,
  DmiF15CzGetExtClock,
  DmiF15CzGetMemInfo,             // Get memory information
  0,
  NULL
};
