 ...
 * @file
 *
 * Initialize the Family 15h Carrizo specific way of running early initialization.
 *
...
CODE_GROUP (G2_PEI)
RDATA_GROUP (G2_PEI)
#define FILECODE PROC_CPU_FAMILY_0X15_CZ_CPUF15CZINITEARLYTABLE_FILECODE
 ...
 */
VOID
GetF15CzEarlyInitBeforeApLaunchOnCoreTable (
...
VOID
GetF15CzEarlyInitAfterApLaunchOnCoreTable (
  IN       CPU_SPECIFIC_SERVICES                *FamilyServices,
     OUT   CONST S_PERFORM_EARLY_INIT_ON_CORE   **Table,
  IN       AMD_CPU_EARLY_PARAMS                 *EarlyParams,
  IN       AMD_CONFIG_PARAMS                    *StdHeader
...
CONST S_PERFORM_EARLY_INIT_ON_CORE ROMDATA F15CzEarlyInitBeforeApLaunchOnCoreTable[] =
{
...
CONST S_PERFORM_EARLY_INIT_ON_CORE ROMDATA F15CzEarlyInitAfterApLaunchOnCoreTable[] =
{
...
{
  *Table = F15CzEarlyInitBeforeApLaunchOnCoreTable;
}
...
{
  *Table = F15CzEarlyInitAfterApLaunchOnCoreTable;
}
