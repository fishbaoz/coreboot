 ...
 * @file
 *
 * AMD CPU Cache Flush On Halt Function for Family 15h Stoney.
 *
 * Contains code to initialize Cache Flush On Halt feature for Family 15h Stoney.
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STCACHEFLUSHONHALT_FILECODE
 ...
 */
VOID
SetF15StCacheFlushOnHaltRegister (
...
{
  PCI_ADDR                              PciAddress;
  F15_ST_CLK_PWR_TIMING_CTRL2_REGISTER  ClkPwrTimingCtrl2;
...
CONST CPU_CFOH_FAMILY_SERVICES ROMDATA F15StCacheFlushOnHalt =
{
  0,
  SetF15StCacheFlushOnHaltRegister
};
