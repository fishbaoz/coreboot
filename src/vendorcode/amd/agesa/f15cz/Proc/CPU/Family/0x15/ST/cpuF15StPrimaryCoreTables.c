 ...
 * @file
 *
 * AMD Family 15h Stoney PCI tables with values as defined in BKDG
 *
 * @xrefitem bom "File Content Label" "Release Content"
 * @e project:      AGESA
 * @e sub-project:  CPU/Family/0x15/ST
 * @e \$Revision: 315141 $   @e \$Date: 2015-03-20 13:48:20 +0800 (Fri, 20 Mar 2015) $
 *
 */
/*
 ******************************************************************************
...
#include "cpuF15StWorkaroundTable.h"
#include "Table.h"
#include "Filecode.h"
CODE_GROUP (G3_DXE)
RDATA_GROUP (G3_DXE)

#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STPRIMARYCORETABLES_FILECODE
...
STATIC CONST UINT8 ROMDATA F15StPrimaryCoresRegistersBeforeApLaunch[] =
{
...
// bit [1]     DisRdDwP = 0
// bit [0]     DisRdBP = 0
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_0, 0x68), 0x004E8810, 0x006E881F),
...
// bits[7:6]   DnRspDBC = 1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x6C), 0x20000040, 0x700000C0),
...
// bits[6:4]     DnReqCBC            = 0x0
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x74), 0x011C0000, 0x07FF7070),
...
// bits[10:6] XbarToSrqFreeListBufCnt = 0x2
// bits[4:0]  SPQPrbFreeCBC = 0xC
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x17C), 0x0000008C, 0x000007DF),

// D18F3x188 - NB Configuration 2
// bit [27] DisCpuWrSzDw64ReOrd   = 0x1
// bit [9]  DisL3HiPriFreeListAlloc = 0x1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x188), 0x08000200, 0x08000200),

// D18F3x1A0 - Core Interface Buffer Count
// bits[18:16] CpuToNbFreeBufCnt = 3
// bits[2:0]   CpuCmdBufCnt = 1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x1A0), 0x00030001, 0x00070007),

// D18F5xA0
// bit[26] EnStallNonUrgentRtOn3OnProbeDrain = 1
// bits[24:21] IsocClkRampHystSelHi = 1
// bit[20] EnNbPstateIsocGap = 1
// bit[10] = 1
// bit[9]  DisOn3LowPriWrSepPrb = 1
// bit[5]  DisOn3WrBurstBoost = 1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_5, 0xA0), 0x04300620, 0x05F00620),
...
STATIC CONST UINT8 ROMDATA F15StPrimaryCoreRegistersAfterApLaunch[] =
{
...
// bit [0]  McaLogUsPwDatErrEn = 1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x180), 0x41281BA1, 0x41281BA1),

// D18F3x198 - MCA NB Control Mask (MC4_CTL_MASK)
// bits[26]      NbArrayPar          = 0x1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_3, 0x198), 0x04000000, 0x04000000),
...
// bits[11:0] CSampleTimer = 0x14
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_4, 0x110), 0x00000014, 0x00000FFF),
...
// bit [3]  = 1
// bit [1]  = 1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_4, 0x218), 0x0000002A, 0x0000002A),
...
// bit [30]                      = 1
/// @todo
//  MAKE_CPU_REV_PCI_ENTRY (AMD_FAMILY_ST, AMD_F15_ST_A0, MAKE_SBDFO (0, 0, 24, FUNC_5, 0x98), 0x40000000, 0x40000000),
...
// bit [9]     FastSlamTimeDown = 1
  MAKE_PCI_ENTRY (MAKE_SBDFO (0, 0, 24, FUNC_5, 0x128), 0x48001200, 0x48003200),
...
// bit [61] Locked
  MAKE_FAM_SPECIFIC_WORKAROUND_ENTRY (F15StNbMcaLockId, 0),

// Table Terminator
  MAKE_TABLE_TERMINATOR
};

CONST REGISTER_TABLE ROMDATA F15StPrimaryCoreRegTableBeforeApLaunch = {
  PrimaryCores,
  F15StPrimaryCoresRegistersBeforeApLaunch,
};

CONST REGISTER_TABLE ROMDATA F15StPrimaryCoreRegTableAfterApLaunch = {
  PrimaryCores,
  F15StPrimaryCoreRegistersAfterApLaunch,
};
