 ...
 * @file
 *
 * AMD Family 15h Stoney C6 C-state feature support functions.
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STC6STATE_FILECODE
...
/*---------------------------------------------------------------------------------------*/
/**
 *  Enable C6 on a family 15h ST CPU.
 *
 * @param[in]    C6Services         Pointer to this CPU's C6 family services.
...
CONST C6_FAMILY_SERVICES ROMDATA F15StC6Support =
{
  0,
  F15StIsC6Supported,
  F15StInitializeC6
