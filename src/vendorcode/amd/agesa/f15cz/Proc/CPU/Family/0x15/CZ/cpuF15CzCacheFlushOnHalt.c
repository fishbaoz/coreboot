 ...
 * @file
 *
 * AMD CPU Cache Flush On Halt Function for Family 15h Carrizo.
 *
 * Contains code to initialize Cache Flush On Halt feature for Family 15h Carrizo.
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_CZ_CPUF15CZCACHEFLUSHONHALT_FILECODE
 ...
 */
VOID
SetF15CzCacheFlushOnHaltRegister (
...
CONST CPU_CFOH_FAMILY_SERVICES ROMDATA F15CzCacheFlushOnHalt =
{
  0,
  SetF15CzCacheFlushOnHaltRegister
};
