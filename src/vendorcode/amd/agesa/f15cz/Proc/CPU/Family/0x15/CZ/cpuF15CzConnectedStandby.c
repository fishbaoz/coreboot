 ...
 * @file
 *
 * AMD Family_15 Carrizo Connected Standby Initialization
 *
 * Enables connected standby.
 *
 * @xrefitem bom "File Content Label" "Release Content"
 * @e project:      AGESA
 * @e sub-project:  CPU/0x15/CZ
...
#define FILECODE PROC_CPU_FAMILY_0X15_CZ_CPUF15CZCONNECTEDSTANDBY_FILECODE
...
BOOLEAN
STATIC
F15CzIsConnectedStandbySupported (
...
AGESA_STATUS
STATIC
F15CzInitializeConnectedStandby (
  IN       CONNECTED_STANDBY_FAMILY_SERVICES *ConnectedStandbyServices,
  IN       PLATFORM_CONFIGURATION *PlatformConfig,
...
VOID
STATIC
F15CzSetConnectedStandbyEnable (
  IN       AMD_CONFIG_PARAMS *StdHeader
  );
/*---------------------------------------------------------------------------------------*/
/**
  ...
  )
{
  ...
  if ((EntryPoint & CPU_FEAT_AFTER_PM_INIT) != 0) {
    ...
    TaskPtr.FuncAddress.PfApTask = F15CzSetConnectedStandbyEnable;
...
/*---------------------------------------------------------------------------------------*/
/**
 *  Enable CSEnable on a family 15h Carrizo core.
 *
...
CONST CONNECTED_STANDBY_FAMILY_SERVICES ROMDATA F15CzConnectedStandbySupport =
{
  0,
  F15CzIsConnectedStandbySupported,
  F15CzInitializeConnectedStandby
