 ...
 * @file
 *
 * AMD Family 15h Stoney specific utility functions.
 *
...
#ifndef _CPU_F15_ST_UTILITES_H_
#define _CPU_F15_ST_UTILITES_H_
...
/// NB Pstate selection table
typedef struct {
  UINT16 MaxTdp;           ///< Max TDP
  UINT8  NbP0Sel;          ///< NbP0 selection
  UINT8  NbP1Sel;          ///< NbP1 selection
  UINT8  NbP2Sel;          ///< NbP2 selection
  UINT8  NbP3Sel;          ///< NbP3 selection
  UINT8  DdrMaxRate;       ///< memory frequency limit
} NB_PSTATE_SELECTION_TABLE;


// NB Pstate High and Nb Pstate Low
#define NB_PS_HIGH 0
#define NB_PS_LOW  1
/*---------------------------------------------------------------------------------------
