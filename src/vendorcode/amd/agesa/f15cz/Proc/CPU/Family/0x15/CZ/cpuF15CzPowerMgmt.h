 ...
 * @file
 *
 * AMD Family 15h Carrizo Power Management related registers defination
 *
...
#ifndef _CPU_F15_CZ_POWERMGMT_H_
#define _CPU_F15_CZ_POWERMGMT_H_

/*
 * Family 15h Carrizo CPU Power Management MSR definitions
 *
 */
...
#define SetF15CzCpuVid(CofVidCtrlMsr, NewCpuVid) ( \
...
#define GetF15CzCurCpuFid(CofVidStsMsr) ( \
...
/*
 * Family 15h Carrizo CPU Power Management PCI definitions
 *
 */
...
} F15_CZ_CLK_PWR_TIMING_CTRL2_REGISTER;
...
#define GetF15CzNbFid(NbPstateRegister) ( \
  ((NB_PSTATE_REGISTER *) NbPstateRegister)->NbFid_5_0)

#define SetF15CzNbFid(NbPstateRegister, NewNbFid) { \
...
#endif /* _CPU_F15_CZ_POWERMGMT_H_ */
