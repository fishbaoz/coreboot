 ...
 * @file
 *
 * AMD Family 15h Stoney MSR tables with values as defined in BKDG
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STALLCORETABLES_FILECODE
...
STATIC CONST UINT8 ROMDATA F15StAllCoreRegistersAfterApLaunch[] =
{
//  M S R    T a b l e s
// ----------------------
...
// bit [39:32] LwpCoreId
  MAKE_FAM_SPECIFIC_WORKAROUND_ENTRY (F15StLwpCoreIdId, 0),

// Table Terminator
  MAKE_TABLE_TERMINATOR
};

CONST REGISTER_TABLE ROMDATA F15StAllCoreRegTableAfterApLaunch = {
  AllCores,
  F15StAllCoreRegistersAfterApLaunch,
};
