 ...
 * @file
 *
 * Initialize the Family 15h Stoney specific way of running early initialization.
 *
...
CODE_GROUP (G2_PEI)
RDATA_GROUP (G2_PEI)
#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STINITEARLYTABLE_FILECODE
 ...
 */
VOID
GetF15StEarlyInitBeforeApLaunchOnCoreTable (
...
VOID
GetF15StEarlyInitAfterApLaunchOnCoreTable (
  IN       CPU_SPECIFIC_SERVICES                *FamilyServices,
     OUT   CONST S_PERFORM_EARLY_INIT_ON_CORE   **Table,
  IN       AMD_CPU_EARLY_PARAMS                 *EarlyParams,
  IN       AMD_CONFIG_PARAMS                    *StdHeader
...
CONST S_PERFORM_EARLY_INIT_ON_CORE ROMDATA F15StEarlyInitBeforeApLaunchOnCoreTable[] =
{
  ...
  /// @todo, comments out below function for Emulaion
  //{F15SetBrandIdRegistersAtEarly, PERFORM_EARLY_ANY_CONDITION},
  {NULL, 0}
};

CONST S_PERFORM_EARLY_INIT_ON_CORE ROMDATA F15StEarlyInitAfterApLaunchOnCoreTable[] =
{
...
{
  *Table = F15StEarlyInitBeforeApLaunchOnCoreTable;
}
...
{
  *Table = F15StEarlyInitAfterApLaunchOnCoreTable;
}
