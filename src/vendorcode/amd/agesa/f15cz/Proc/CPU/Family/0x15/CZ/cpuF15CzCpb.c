 ...
 * @file
 *
 * AMD Family 15h Carrizo CPB Initialization
 *
...
#define FILECODE PROC_CPU_FAMILY_0X15_CZ_CPUF15CZCPB_FILECODE
...
CONST CPB_FAMILY_SERVICES ROMDATA F15CzCpbSupport =
{
  0,
  F15CzIsCpbSupported,
  F15CzInitializeCpb
