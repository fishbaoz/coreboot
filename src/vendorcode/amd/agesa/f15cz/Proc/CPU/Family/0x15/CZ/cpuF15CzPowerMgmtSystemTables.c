 ...
 * @file
 *
 * AMD Family 15h Carrizo Models 0x60 - 0x6F Power Management related initialization table
 *
...
#include "cpuF15CzNbAfterReset.h"
...
#define FILECODE PROC_CPU_FAMILY_0X15_CZ_CPUF15CZPOWERMGMTSYSTEMTABLES_FILECODE
...
/*  Family 15h CZ Only Table */
/* ---------------------- */
CONST SYS_PM_TBL_STEP ROMDATA CpuF15CzSysPmTableArray[] =
{
  IDS_INITIAL_F15_CZ_PM_STEP

  // Step 1 - Config NB Pstate
  //   Execute only after cold reset
  {
    0,                                                // ExeFlags
    F15CzNbPstateConfig                               // Function Pointer
  },
  ...
  {
    0,                                                // ExeFlags
    F15CzNbPstateDis                                  // Function Pointer
  },
  ...
  //   Execute only after warm reset
  {
    ...
    F15CzPmCoreAfterReset                             // Function Pointer
  },
  ...
  {
    PM_EXEFLAGS_WARM_ONLY,                            // ExeFlags
    F15CzPmNbAfterReset                               // Function Pointer
  },
  IDS_F15_CZ_PM_CUSTOM_STEP
...
{
  *NumberOfElements = (sizeof (CpuF15CzSysPmTableArray) / sizeof (SYS_PM_TBL_STEP));
  *SysPmTblPtr = CpuF15CzSysPmTableArray;
}
