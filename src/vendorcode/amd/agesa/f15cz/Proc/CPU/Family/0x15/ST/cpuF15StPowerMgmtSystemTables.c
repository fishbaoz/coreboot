 ...
 * @file
 *
 * AMD Family 15h Stoney Models 0x60 - 0x6F Power Management related initialization table
 *
...
#include "cpuF15StNbAfterReset.h"
...
#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STPOWERMGMTSYSTEMTABLES_FILECODE
...
/*  Family 15h ST Only Table */
/* ---------------------- */
CONST SYS_PM_TBL_STEP ROMDATA CpuF15StSysPmTableArray[] =
{
  IDS_INITIAL_F15_ST_PM_STEP
/// @todo, comments out below PM entries only for Emulation
/*
  // Step 1 - Config NB Pstate
  //   Execute only after cold reset
  {
    0,                                                // ExeFlags
    F15StNbPstateConfig                               // Function Pointer
  },
  ...
  {
    0,                                                // ExeFlags
    F15StNbPstateDis                                  // Function Pointer
  },
  ...
  //   Execute only after warm reset
  {
    ...
    F15StPmCoreAfterReset                             // Function Pointer
  },
  ...
  {
    PM_EXEFLAGS_WARM_ONLY,                            // ExeFlags
    F15StPmNbAfterReset                               // Function Pointer
  },*/
  IDS_F15_ST_PM_CUSTOM_STEP
...
{
  *NumberOfElements = (sizeof (CpuF15StSysPmTableArray) / sizeof (SYS_PM_TBL_STEP));
  *SysPmTblPtr = CpuF15StSysPmTableArray;
}
