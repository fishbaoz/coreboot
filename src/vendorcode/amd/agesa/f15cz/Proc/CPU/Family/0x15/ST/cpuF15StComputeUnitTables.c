 ...
 * @file
 *
 * AMD Family 15h Stoney Shared MSR table with values as defined in BKDG
 *
 * @xrefitem bom "File Content Label" "Release Content"
 * @e project:      AGESA
 * @e sub-project:  CPU/Family/0x15/ST
 * @e \$Revision: 313860 $   @e \$Date: 2015-03-02 13:49:56 +0800 (Mon, 02 Mar 2015) $
 *
 */
/*
 ******************************************************************************
...
#define FILECODE PROC_CPU_FAMILY_0X15_ST_CPUF15STCOMPUTEUNITTABLES_FILECODE
 ...
 *----------------------------------------------------------------------------------------
 */
STATIC CONST UINT8 ROMDATA F15StComputeUnitRegistersAfterApLaunch[] =
{
//  M S R    T a b l e s
// ----------------------
...
///@todo, confirm if bit 24, 23, 12, 11 need to be set
// bit[24]                            = 1
// bit[23]                            = 1
// bit[20]                            = 1
// bit[12]                            = 1
...
STATIC CONST UINT8 ROMDATA F15StComputeUnitRegistersBeforeApLaunch[] =
{
...
CONST REGISTER_TABLE ROMDATA F15StCURegTableAfterApLaunch = {
  ComputeUnitPrimary,
  F15StComputeUnitRegistersAfterApLaunch,
};

CONST REGISTER_TABLE ROMDATA F15StCURegTableBeforeApLaunch = {
  ComputeUnitPrimary,
  F15StComputeUnitRegistersBeforeApLaunch,
};
