  ...
  )
{
  ...
  IDS_PERF_TIMESTAMP (TP_BEGINGNBINITATRTB, &(AmdInitRtbParams->StdHeader));
  AgesaStatus = GnbInitAtRtb (AmdInitRtbParams);
  IDS_PERF_TIMESTAMP (TP_ENDGNBINITATRTB, &(AmdInitRtbParams->StdHeader));
