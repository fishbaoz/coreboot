  ...
  )
{
  ...
  PlatformConfig->Resolution = UserOptions.CfgGnbResolution;
  PlatformConfig->AcpSize = UserOptions.CfgGnbAcpSize;

  // BBB
  PlatformConfig->BatteryBoostTune = UserOptions.CfgBatteryBoostTune;
  // PkgPwerLimit
  PlatformConfig->PkgPwrLimitAC = UserOptions.CfgPkgPwrLimitAC;
  PlatformConfig->PkgPwrLimitDC = UserOptions.CfgPkgPwrLimitDC;
  // SMU system configuration
  PlatformConfig->SystemConfiguration = UserOptions.CfgSystemConfiguration;
  // STAPM
  PlatformConfig->PlatStapmConfig = UserOptions.CfgPlatStapmConfig;
  // ThermCtl Limit
  PlatformConfig->ThermCtlLimit = UserOptions.CfgThermCtlLimit;
  // Azalia Codec Verbtable
  PlatformConfig->AzaliaCodecVerbTable = UserOptions.CfgCodecVerbTable;
  // Azalia SSID
  PlatformConfig->AzaliaSsid = UserOptions.CfgGnbAzSsid;
  PlatformConfig->GnbAzI2sBusSelect = UserOptions.CfgGnbAzI2sBusSelect;
  PlatformConfig->GnbAzI2sBusPinConfig = UserOptions.CfgGnbAzI2sBusPinConfig;
