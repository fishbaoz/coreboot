...
#define FILECODE PROC_MEM_NB_CZ_MNMCTCZ_FILECODE
/*----------------------------------------------------------------------------
  ...
  )
{
  ...
  if ((IsFeatureEnabled (C6Cstate, NBPtr->MemPtr->PlatFormConfig, &(NBPtr->MemPtr->StdHeader)) || MemPspDetectionMechanismCZ (NBPtr)) && AcpEngineFeature) {
  ...
  // Only CC6 is enabled.
  } else if (IsFeatureEnabled (C6Cstate, NBPtr->MemPtr->PlatFormConfig, &(NBPtr->MemPtr->StdHeader)) || MemPspDetectionMechanismCZ (NBPtr))  {
  ...
  )
{
  ...
  // Set LockDramCfg
  if (IsFeatureEnabled (C6Cstate, NBPtr->MemPtr->PlatFormConfig, &(NBPtr->MemPtr->StdHeader)) || MemPspDetectionMechanismCZ (NBPtr)) {
