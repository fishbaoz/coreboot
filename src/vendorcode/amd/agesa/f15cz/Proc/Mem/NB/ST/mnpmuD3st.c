...
#define FILECODE PROC_MEM_NB_ST_MNPMUD3ST_FILECODE
...
ROMDATA PMU_FIRMWARE PmuFirmwareD3ImageTableST[] = {
//
//  PMU Signature  Instance   Package String      NULL Reserved   Size                                           Image Data
//
  {{PMU_SIGNATURE,    '0',    PMU_PACKAGE_STRING,  0,     {0}  }, PMU_SRAM_DMEM_SIZE_ST + PMU_SRAM_IMEM_SIZE_ST, PMU_DDR3_ST_8a81   },
  {{PMU_SIGNATURE,    '1',    PMU_PACKAGE_STRING,  0,     {0}  }, PMU_IMAGE_NOT_USEABLE },
};
ROMDATA UINT8 PmuFirmwareD3ImageTableSizeST = GET_SIZE_OF (PmuFirmwareD3ImageTableST);
...
VOID
MemNPopulatePmuSramTimingsD3ST (
  IN OUT   MEM_NB_BLOCK *NBPtr
  )
{
  UINT32 Mr0;
