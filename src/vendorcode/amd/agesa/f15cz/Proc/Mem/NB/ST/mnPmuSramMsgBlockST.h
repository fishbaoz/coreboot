 ...
 * @file
 *
 * mnPmuSramMsgBlockST.h
 *
 * PMU SRAM Message Block related function for ST.
 *
...
#ifndef _MNPMUSRAMMSGBLOCKST_H_
#define _MNPMUSRAMMSGBLOCKST_H_
...
// The structure maps directly from PMU SRAM Message Block table in the ST BKDG.
//

/// DDR3 Unbuffered PMU SRAM Message Block Annex for DDR3 Unbuffered
typedef struct _PMU_SMB_DDR3U_ST {
...
typedef struct _PMU_SMB_DDR3R_ST {
  IN     UINT16    M0_MR0;          ///< Location 21h:20h,
  IN     UINT16    M0_MR1;          ///< Location 23h:22h,
  IN     UINT16    M0_MR2;          ///< Location 25h:24h,
  IN     UINT8     Reserved26;      ///< Location 26h,
...
typedef struct _PMU_SMB_DDR3L_ST {
  IN     UINT16    M0_MR0;             ///< Location 21h:20h,
  IN     UINT16    M0_MR1;             ///< Location 23h:22h,
  IN     UINT16    M0_MR2;             ///< Location 25h:24h,
  IN     UINT8     Reserved26;         ///< Location 26h,
...
typedef struct _PMU_SMB_DDR4R_ST {
  IN     UINT16    M0_MR0;          ///< Location 21h:20h,
  IN     UINT16    M0_MR1;          ///< Location 23h:22h,
  IN     UINT16    M0_MR2;          ///< Location 25h:24h,
...
typedef struct _PMU_SMB_DDR4U_ST {
  IN     UINT16    M0_MR0;         ///< Location 21h:20h,
  IN     UINT16    M0_MR1;         ///< Location 23h:22h,
  IN     UINT16    M0_MR2;         ///< Location 25h:24h,
  IN     UINT16    M0_MR3;         ///< Location 27h:26h,
...
typedef union _PMU_SRAM_MSG_BLOCK_ANNEX_ST {
  IN OUT PMU_SMB_DDR3U_ST  D3u;   ///< Annex for DDR3 Unbuffered
  IN OUT PMU_SMB_DDR4U_ST  D4u;   ///< Annex for DDR4 Unbuffered
} PMU_SRAM_MSG_BLOCK_ANNEX_ST;

/// Base PMU SRAM Message Block Base
typedef struct _PMU_SRAM_MSG_BLOCK_ST {
  ...
  IN OUT PMU_SRAM_MSG_BLOCK_ANNEX_ST Annex; ///< See Annexes
} PMU_SRAM_MSG_BLOCK_ST;
