...
#define FILECODE PROC_MEM_NB_CZ_MNPMUD4CZ_FILECODE
...
//
  {{PMU_SIGNATURE,    '2',    PMU_PACKAGE_STRING,  0,     {0}  }, PMU_SRAM_DMEM_SIZE_CZ + PMU_SRAM_IMEM_SIZE_CZ, PMU_DDR4_CZ_9040   },
  {{PMU_SIGNATURE,    '3',    PMU_PACKAGE_STRING,  0,     {0}  }, PMU_SRAM_DMEM_SIZE_CZ + PMU_SRAM_IMEM_SIZE_CZ, PMU2D_DDR4_CZ_9040 },
};
