 ...
 * mflvddr4.c
 *
 * Voltage change for DDR4 DIMMs.
 *
 * @xrefitem bom "File Content Label" "Release Content"
 * @e project: AGESA
 * @e sub-project: (Mem/Feat/LVDDR4)
 * @e \$Revision: 310652 $ @e \$Date: 2015-01-12 02:21:39 +0800 (Mon, 12 Jan 2015) $
 *
 **/
/*****************************************************************************
*
...
#define FILECODE PROC_MEM_FEAT_LVDDR4_MFLVDDR4_FILECODE
/* features */
#include "mflvddr4.h"
...
/**
 *
 *   This function calculate the common lowest voltage supported by all DDR4
