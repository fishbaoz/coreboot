 ...
 * mpSst3.c
 *
 * Platform specific settings for ST DDR3 SO-DIMM system
 *
...
#define FILECODE PROC_MEM_PS_ST_MPSST3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_CADBUS_ENTRY ROMDATA CadBusSTSODIMM3[] = {
...
CONST PSC_TBL_ENTRY STCadBusTblEnSO3 = {
   {PSCFG_CADBUS, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (CadBusSTSODIMM3) / sizeof (PSCFG_CADBUS_ENTRY),
   (VOID *)&CadBusSTSODIMM3
};
...
//
STATIC CONST PSCFG_DATABUS_ENTRY_D3 ROMDATA DataBusSTSODIMM3[] = {
...
CONST PSC_TBL_ENTRY STDataBusTblEnSO3 = {
   {PSCFG_DATABUS, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (DataBusSTSODIMM3) / sizeof (PSCFG_DATABUS_ENTRY_D3),
   (VOID *)&DataBusSTSODIMM3
};
