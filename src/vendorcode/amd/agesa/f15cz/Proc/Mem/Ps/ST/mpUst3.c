 ...
 * mpUst3.c
 *
 * Platform specific settings for ST DDR3 UDIMM system
 *
...
#define FILECODE PROC_MEM_PS_ST_MPUST3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_CADBUS_ENTRY ROMDATA CadBusSTUDIMM3[] = {
...
CONST PSC_TBL_ENTRY STCadBusTblEnU3 = {
   {PSCFG_CADBUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (CadBusSTUDIMM3) / sizeof (PSCFG_CADBUS_ENTRY),
   (VOID *)&CadBusSTUDIMM3
};
...
//
STATIC CONST PSCFG_DATABUS_ENTRY_D3 ROMDATA DataBusSTUDIMM3[] = {
...
CONST PSC_TBL_ENTRY STDataBusTblEnU3 = {
   {PSCFG_DATABUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (DataBusSTUDIMM3) / sizeof (PSCFG_DATABUS_ENTRY_D3),
   (VOID *)&DataBusSTUDIMM3
};
