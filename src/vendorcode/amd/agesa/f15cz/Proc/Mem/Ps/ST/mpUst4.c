 ...
 * mpUst4.c
 *
 * Platform specific settings for ST DDR4 UDIMM system
 *
...
#define FILECODE PROC_MEM_PS_ST_MPUST4_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_CADBUS_ENTRY ROMDATA CadBusSTUDIMM4[] = {
  {1, DDR1333 +
      DDR1600 +
      DDR1866 +
      DDR2133 +
...
CONST PSC_TBL_ENTRY STCadBusTblEnU4 = {
   {PSCFG_CADBUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (CadBusSTUDIMM4) / sizeof (PSCFG_CADBUS_ENTRY),
   (VOID *)&CadBusSTUDIMM4
};

// Data Bus configuration for UDIMM (ST A0 Only)
// Format :
// DimmPerCh, DDRrate,   VDDIO,      Dimm0,   Dimm1,   RttNom,    RttWr,    RttPark,   DQ,  DQS,  ODT strength
//
STATIC CONST PSCFG_DATABUS_ENTRY_D4 ROMDATA DataBusSTUDIMM4_A0[] = {
...
CONST PSC_TBL_ENTRY STDataBusTblEnU4_A0 = {
   {PSCFG_DATABUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ST_A0}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (DataBusSTUDIMM4_A0) / sizeof (PSCFG_DATABUS_ENTRY_D4),
   (VOID *)&DataBusSTUDIMM4_A0
};

// Data Bus configuration for UDIMM (ST A1 or Later)
// Format :
// DimmPerCh, DDRrate,   VDDIO,              Dimm0,             Dimm1,  RttNom,     RttWr,   RttPark,   DQ,  DQS, ODT strength
//
STATIC CONST PSCFG_DATABUS_ENTRY_D4 ROMDATA DataBusSTUDIMM4[] = {
...
CONST PSC_TBL_ENTRY STDataBusTblEnU4 = {
   {PSCFG_DATABUS, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ST_GTE_A1}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (DataBusSTUDIMM4) / sizeof (PSCFG_DATABUS_ENTRY_D4),
   (VOID *)&DataBusSTUDIMM4
};
