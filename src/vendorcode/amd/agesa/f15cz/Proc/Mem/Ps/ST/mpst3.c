 ...
 * mpst3.c
 *
 * Platform specific settings for ST
 *
...
#define FILECODE PROC_MEM_PS_ST_MPST3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_2D_ODTPAT_ENTRY STOdtPat3[] = {
...
CONST PSC_TBL_ENTRY STOdtPatTblEnt3 = {
   {PSCFG_ODT_PAT_2D, DT_DONT_CARE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (STOdtPat3) / sizeof (PSCFG_2D_ODTPAT_ENTRY),
   (VOID *)&STOdtPat3
};
