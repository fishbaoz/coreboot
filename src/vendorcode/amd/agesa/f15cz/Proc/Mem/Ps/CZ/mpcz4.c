...
#define FILECODE PROC_MEM_PS_CZ_MPCZ4_FILECODE
/*----------------------------------------------------------------------------
...
CONST PSC_TBL_ENTRY CZOdtPatTblEnt4 = {
   {PSCFG_ODT_PAT_2D, DT_DONT_CARE, NOD_DONT_CARE, {AMD_FAMILY_15_CZ, AMD_F15_ALL}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
