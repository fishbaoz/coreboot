...
#define FILECODE PROC_MEM_PS_CZ_FP4_MPSCZFP4D4_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqCZSODIMMFP4D4[] = {
...
CONST PSC_TBL_ENTRY CZMaxFreqTblEntSOFP4D4 = {
   ...
   sizeof (MaxFreqCZSODIMMFP4D4) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqCZSODIMMFP4D4
};
