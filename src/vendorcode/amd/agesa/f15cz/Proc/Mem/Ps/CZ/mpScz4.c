...
#define FILECODE PROC_MEM_PS_CZ_MPSCZ4_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_CADBUS_ENTRY ROMDATA CadBusCZSODIMM4[] = {
...
CONST PSC_TBL_ENTRY CZCadBusTblEnSO4 = {
   {PSCFG_CADBUS, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_CZ, AMD_F15_ALL}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (CadBusCZSODIMM4) / sizeof (PSCFG_CADBUS_ENTRY),
   (VOID *)&CadBusCZSODIMM4
};


// Data Bus configuration for SO-DIMM (CZ A0 Only)
// Format :
// DimmPerCh, DDRrate,                      VDDIO, Dimm0,   Dimm1,                       RttNom,     RttWr,     Rtt_Park,   DQ,   DQS, ODT strength
//
STATIC CONST PSCFG_DATABUS_ENTRY_D4 ROMDATA DataBusCZSODIMM4_A0[] = {
...
CONST PSC_TBL_ENTRY CZDataBusTblEnSO4_A0 = {
   {PSCFG_DATABUS, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_CZ, AMD_F15_CZ_A0}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (DataBusCZSODIMM4_A0) / sizeof (PSCFG_DATABUS_ENTRY_D4),
   (VOID *)&DataBusCZSODIMM4_A0
};

// Data Bus configuration for SO-DIMM (CZ A1 or Later)
// Format :
// DimmPerCh, DDRrate,                      VDDIO, Dimm0,   Dimm1,                       RttNom,     RttWr,     Rtt_Park,   DQ,   DQS, ODT strength
//
STATIC CONST PSCFG_DATABUS_ENTRY_D4 ROMDATA DataBusCZSODIMM4[] = {
...
CONST PSC_TBL_ENTRY CZDataBusTblEnSO4 = {
   {PSCFG_DATABUS, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_CZ, AMD_F15_CZ_GTE_A1}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (DataBusCZSODIMM4) / sizeof (PSCFG_DATABUS_ENTRY_D4),
   (VOID *)&DataBusCZSODIMM4
};
