...
#define FILECODE PROC_MEM_PS_CZ_FP4_MPUCZFP4D4_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqCZUDIMMFP4D4[] = {
...
CONST PSC_TBL_ENTRY CZMaxFreqTblEntUFP4D4 = {
   ...
   sizeof (MaxFreqCZUDIMMFP4D4) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqCZUDIMMFP4D4
};
