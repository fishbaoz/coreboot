...
#define FILECODE PROC_MEM_PS_ST_FP4_MPUSTFP4D3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqSTUDIMMFP4D3[] = {
...
CONST PSC_TBL_ENTRY STMaxFreqTblEntUFP4D3 = {
   {PSCFG_MAXFREQ, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, ST_SOCKET_FP4, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (MaxFreqSTUDIMMFP4D3) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqSTUDIMMFP4D3
};
