 ...
 * mpst4.c
 *
 * Platform specific settings for ST with DDR4
 *
...
#define FILECODE PROC_MEM_PS_ST_MPST4_FILECODE
/*----------------------------------------------------------------------------
 ...
 */
//
// Common tables of ST platform specific configuration
//
...
//
STATIC CONST PSCFG_2D_ODTPAT_ENTRY STOdtPat4[] = {
...
CONST PSC_TBL_ENTRY STOdtPatTblEnt4 = {
   {PSCFG_ODT_PAT_2D, DT_DONT_CARE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (STOdtPat4) / sizeof (PSCFG_2D_ODTPAT_ENTRY),
   (VOID *)&STOdtPat4
};
