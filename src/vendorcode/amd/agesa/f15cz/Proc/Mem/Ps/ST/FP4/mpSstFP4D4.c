...
#define FILECODE PROC_MEM_PS_ST_FP4_MPSSTFP4D4_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqSTSODIMMFP4D4[] = {
...
CONST PSC_TBL_ENTRY STMaxFreqTblEntSOFP4D4 = {
   {PSCFG_MAXFREQ, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, ST_SOCKET_FP4, DDR4_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (MaxFreqSTSODIMMFP4D4) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqSTSODIMMFP4D4
};
