...
#define FILECODE PROC_MEM_PS_CZ_FP4_MPSCZFP4D3_FILECODE
/*----------------------------------------------------------------------------
...
//
STATIC CONST PSCFG_MAXFREQ_ENTRY ROMDATA MaxFreqCZSODIMMFP4D3[] = {
...
CONST PSC_TBL_ENTRY CZMaxFreqTblEntSOFP4D3 = {
   {PSCFG_MAXFREQ, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_CZ, AMD_F15_ALL}, CZ_SOCKET_FP4, DDR3_TECHNOLOGY, MBL_DONT_CARE, MBP_DONT_CARE},
   sizeof (MaxFreqCZSODIMMFP4D3) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxFreqCZSODIMMFP4D3
};