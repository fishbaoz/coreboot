 ...
 * @file
 *
 * AMD IEM Option Specific Routines for F15 ST
 *
...
#define FILECODE PROC_IDS_INTERNAL_FAMILY_0X15_ST_IEMF15ST_FILECODE
  ...
  )
{
  ...
  //
  // Locate Get PMU SRAM Message Block Buffer Pointer
  //
  ...
  //
  IDS_HDT_CONSOLE (MEM_FLOW, "\t\tEmulation Override: SequenceCtl = 0x1\n");
