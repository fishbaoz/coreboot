 ...
 *
 ***************************************************************************/
#ifndef _IDS_INT_F15_ALLSERVICE_H_
#define _IDS_INT_F15_ALLSERVICE_H_
/// CST Header
typedef struct _IDS_CST_HEADER_STRUCT {
...
} IDS_CST_HEADER_STRUCT;

/// CST Body
typedef struct _IDS_CST_BODY_STRUCT {
...
/// CSD Header
typedef struct _IDS_CSD_HEADER_STRUCT {
  UINT8   NameOpcode;     ///< Name Opcode
  ...
  UINT8   PkgElements;    ///< Number of Elements
} IDS_CSD_HEADER_STRUCT;

/// CSD Body
typedef struct _IDS_CSD_BODY_STRUCT {
  UINT8   PkgOpcode2;     ///< Package Opcode
  UINT8   PkgLength2;     ///< Package Length
  UINT8   PkgElements2;   ///< Number of Elements
  UINT8   BytePrefix;     ///< Byte Prefix Opcode
