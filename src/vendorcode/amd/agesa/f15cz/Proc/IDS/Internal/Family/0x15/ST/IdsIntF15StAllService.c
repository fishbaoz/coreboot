...
#include "mp.h"
#include "mnreg.h"
#include "IdsIntF15StAllService.h"
#include "OptionGnb.h"
CODE_GROUP (G3_DXE)
RDATA_GROUP (G3_DXE)

///Please check IdsInternalLib.h for internal FILECODE
#define FILECODE PROC_IDS_INTERNAL_FAMILY_0X15_ST_IDSINTF15STALLSERVICE_FILECODE

// Stretch Max Freq for unbuffered dimm.
// Format :
// DimmPerCh,   Dimms,   SR,   DR,   QR,   Speed1_5V,   Speed1_35V,   Speed1_25V
//
STATIC PSCFG_MAXFREQ_ENTRY ROMDATA MaxStretchFreqSTUDIMM[] = {
...
STATIC PSC_TBL_ENTRY STMaxStretchFreqTblEntU = {
   {PSCFG_MAXFREQ, UDIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (MaxStretchFreqSTUDIMM) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxStretchFreqSTUDIMM
};
...
// DimmPerCh,   Dimms,   SR,   DR,   QR,   Speed1_5V,   Speed1_35V,   Speed1_25V
//
STATIC PSCFG_MAXFREQ_ENTRY ROMDATA MaxStretchFreqSTSODIMM[] = {
  {_1DIMM, 1, 1, 0, 0, DDR2133_FREQUENCY, DDR1866_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY},
  {_1DIMM, 1, 0, 1, 0, DDR2133_FREQUENCY, DDR1866_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY},
...
STATIC PSC_TBL_ENTRY STStretchMaxFreqTblEntSO = {
   {PSCFG_MAXFREQ, SODIMM_TYPE, NOD_DONT_CARE, {AMD_FAMILY_15_ST, AMD_F15_ALL}, PT_DONT_CARE, DDR3_TECHNOLOGY},
   sizeof (MaxStretchFreqSTSODIMM) / sizeof (PSCFG_MAXFREQ_ENTRY),
   (VOID *)&MaxStretchFreqSTSODIMM
};

STATIC PSC_TBL_ENTRY* memPSCTblMaxStretchFreqArrayST[] = {
  &STMaxStretchFreqTblEntU,
  &STStretchMaxFreqTblEntSO,
  NULL
};
 ...
 **/
IDS_STATUS
IdsIntFeatWatchdogTimerAndSyncFloodMcaF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntFeatExceptionBreakpointF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
  ...
  )
{
  ...
  //Reserve system memory for ST ACP engine
  ...
  )
{
  ...
  for (MsrAddr = MSR_PSTATE_0; MsrAddr <= MSR_PSTATE_0 + CpbReg.NumBoostStates; MsrAddr++) {
    SetUnFusedPstateF15St (StdHeader, MsrAddr);
  }
  ...
  // Transition to P0.
  TaskPtr.FuncAddress.PfApTaskI = ChangePstateF15St;
  ...
  )
{
  ...
  GnbRegisterReadST (GnbHandle, D0F0xBC_xD8230F00_TYPE, D0F0xBC_xD8230F00_ADDRESS, &D0F0xBC_xD8230F00.Value, 0, StdHeader);
  ...
  if (D0F0xBC_xD8230F00.Field.COF_VID_PROG == 0) {
    ...
    SetUnFusedFidVidRegsF15St (StdHeader, CpuEarlyParamsPtr);
  }
}
  ...
  )
{
  ...
  SetF15StCpuFid (PMsrValue, pstatereg->corefid);
 ...
 **/
VOID
IdsSetCustomPstatesCommonCoreF15St (
  IN       VOID *dataptr,
  IN OUT   AMD_CONFIG_PARAMS  *StdHeader
  )
{
  ...
  for (i = 0; i < PsNum; i++) {
    IdsProgPstatesCommonF15St (i, &(pcustompstate->pstatereg[i]), StdHeader);
  }
  ...
  IDS_NV_READ_SKIP (idsvalue, AGESA_IDS_NV_CUSTOM_PSTATE, IdsNvPtr, StdHeader) {
    if (idsvalue == IdsNvCpuPstCustomPStateEnabled) {
      ...
      IDS_NV_READ_SKIP (psnum, AGESA_IDS_NV_NUMCUSTOMPSTATES, IdsNvPtr, StdHeader) {
        ...
        TaskPtr.FuncAddress.PfApTaskI = IdsSetCustomPstatesCommonCoreF15St;
 ...
 **/
IDS_STATUS
IdsIntSubNbPstateDisOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS  *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSubNbPstateOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS  *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
  ...
  IDS_NV_READ_SKIP (NvValue, AGESA_IDS_NV_CUSTOM_NB_PSTATE, IdsNvPtr, StdHeader) {
    ...
    case IdsNvCpuCustomNBPstatesManual:
      ...
      for (i = 0; i < 4; i++) {
        ...
        LibAmdPciRead (AccessWidth32, PciAddress, &NbPsReg, StdHeader);
        SetF15StNbFid (&NbPsReg, GETPXNBFID (i, IdsNvPtr, StdHeader));
 ...
 **/
VOID
IdsProgDeadLockWidgetDisCommonCoreF15St (
  IN       VOID *dataptr,
  IN OUT   AMD_CONFIG_PARAMS  *StdHeader
  )
{
 ...
 **/
IDS_STATUS
IdsIntSubProgDeadLockWidgetDisF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS  *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
{
  ...
  IDS_NV_READ_SKIP (NvValue, AGESA_IDS_NV_DEADLOCK_WIDGET_DIS, IdsNvPtr, StdHeader) {
    ...
    case IDS_NV_DEADLOCK_WIDGET_DIS_1:
      MsrValue = NvValue;
      CpuEarlyParamsPtr = (AMD_CPU_EARLY_PARAMS *) DataPtr;
      TaskPtr.FuncAddress.PfApTaskI = IdsProgDeadLockWidgetDisCommonCoreF15St;
      TaskPtr.ExeFlags = WAIT_FOR_CORE;
...
VOID
STATIC
IdsProgDsmLpDisCommonCoreF15St (
  IN       VOID *dataptr,
  IN       AMD_CONFIG_PARAMS *StdHeader
  )
{
...
//  UINT32                DsmData;
//
//  GnbRegisterReadST (GnbHandle, GMMx194_TYPE, GMMx194_ADDRESS, &GMMx194, 0, StdHeader);
//  GMMx194.Field.DSM_SPR_WREN_D4 = 0;
//  GMMx194.Field.DSM_SPR_WREN_D5 = 0;
//  GMMx194.Field.DSM_SPR_RDEN_D5 = 0;
//  GMMx194.Field.DBG_EN = 1;
//  GnbRegisterWriteST (GnbHandle, GMMx194_TYPE, GMMx194_ADDRESS, &GMMx194.Value, GNB_REG_ACC_FLAG_S3SAVE, StdHeader);
//
//  GnbRegisterReadST (GnbHandle, GMMx190_TYPE, GMMx190_ADDRESS, &GMMx190, 0, StdHeader);
//  GMMx190.Field.DRB_SEL = 0;
//  GMMx190.Field.DSM_SEL = 1;
//  GMMx190.Field.ADDR = RegisterAddress;
//  GnbRegisterWriteST (GnbHandle, GMMx190_TYPE, GMMx190_ADDRESS, &GMMx190.Value, GNB_REG_ACC_FLAG_S3SAVE, StdHeader);
//
//  DsmData = (UINT32) ((RegisterData >> 32) & 0xFFFFFFFF);
//  GnbRegisterWriteST (GnbHandle, GMMx198_TYPE, GMMx198_ADDRESS, &DsmData, GNB_REG_ACC_FLAG_S3SAVE, StdHeader);
//
...
//  GnbRegisterWriteST (GnbHandle, GMMx190_TYPE, GMMx190_ADDRESS, &GMMx190.Value, GNB_REG_ACC_FLAG_S3SAVE, StdHeader);
//
//  GnbRegisterReadST (GnbHandle, GMMx198_TYPE, GMMx198_ADDRESS, &DsmData, 0, StdHeader);
  ...
  )
{
  ...
  IDS_NV_READ_SKIP (NvValue, AGESA_IDS_NV_DSM_LP_SEL_EN, IdsNvPtr, StdHeader) {
    ...
    case IdsNvDsmLpEnabled:
      CpuEarlyParamsPtr = (AMD_CPU_EARLY_PARAMS *) DataPtr;
      TaskPtr.FuncAddress.PfApTaskI = IdsProgDsmLpDisCommonCoreF15St;
      TaskPtr.ExeFlags = WAIT_FOR_CORE;
      ...
      GnbHandle = GnbGetHandle (StdHeader);
      IdsGnbDsmLpRegReadSt (GnbHandle, 0, &DsmData, StdHeader);
      DsmData &= ~BIT51;
      DsmData |= ((UINT64) NvValue) << 51;
      IdsGnbDsmLpRegWriteSt (GnbHandle, 0, DsmData, StdHeader);
  ...
  )
{
  ...
  SetUnFusedPartF15St (FamilySpecificServices, CpuEarlyParamsPtr, StdHeader);

  AmdGetIdsNvTable (&IdsNvPtr, StdHeader);
  if (IdsNvPtr != NULL) {
    //Program DEADLOCK_WIDGET_DIS before PM init
    IdsIntSubProgDeadLockWidgetDisF15St (CpuEarlyParamsPtr, StdHeader, IdsNvPtr);

    IdsIntSubDsmLpCfgF15St  (CpuEarlyParamsPtr, StdHeader, IdsNvPtr);
  }
}
  ...
  )
{
  ...
  if (IdsNvPtr != NULL) {
    ...
    IdsIntSubVoltageCtrlF15St (CpuEarlyParamsPtr, StdHeader, IdsNvPtr);
    //Custom P-state
    IdsIntSubPstateOverrideF15St (CpuEarlyParamsPtr, StdHeader, IdsNvPtr);
    // Custom NB P-state
    IdsIntSubNbPstateOverrideF15St (CpuEarlyParamsPtr, StdHeader, IdsNvPtr);
  }
}
  ...
  )
{
  ...
  F15_ST_CLK_PWR_TIMING_CTRL2_REGISTER ClkPwrTimingCtrl2Reg;
 ...
 **/
VOID
IdsMemTblDramControllerDdr3F15St (
  IN OUT   MEM_TABLE_ALIAS **MemTblPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr,
  IN OUT   MEM_NB_BLOCK *NBPtr
         ...
         //Opportunistic write enh disable
          ...
          IDS_NV_READ_SKIP (NvValue, AGESA_IDS_NV_BANKGROUPSWAP, IdsNvPtr, StdHeader) {
            ...
            case  IdsNvMemCtrllerBankGroupSwapDis:
              MAKE_MEM_TABLE_ALIAS ((*MemTblPtr), MTBeforeDInit, MTNodes, (UINT8)DRAMContrSelDct, MTDIMMs, MTBLs, BFBankGroupSwap, MTOverride, NvValue);
              (*MemTblPtr)++;
              break;
            //Auto
 ...
 **/
VOID
IdsMemTblDriveStrengthDdr3F15St (
  IN OUT   MEM_TABLE_ALIAS **MemTblPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr,
  IN OUT   MEM_NB_BLOCK *NBPtr
    ...
    case  IdsNvMemDrvCtlManual:
      ...
      IDS_NV_READ_SKIP (NvValue, AGESA_IDS_NV_DQSPROCODT, IdsNvPtr, StdHeader) {
        ...
        case  IdsNvMemDrvProcODT60_ohm:
          MAKE_MEM_TABLE_ALIAS ((*MemTblPtr), MTAfterPlatformSpec, MTNodes, MTDcts, MTDIMMs, MTBLs, BF_DQS_PROC_ODT, MTOverride, NvValue);
          (*MemTblPtr)++;
          break;
        //Auto
  ...
  )
{
  ...
  if (status == AGESA_SUCCESS) {
    *((UINT16 *)pidsmemheap) = 0x55AA;
    ...
    IdsMemTblDramTimingDdr3F15St (&pidsmemheap, StdHeader, IdsNvPtr, NBPtr);
    IdsMemTblDramControllerDdr3F15St (&pidsmemheap, StdHeader, IdsNvPtr, NBPtr);
    IdsMemTblDriveStrengthDdr3F15St (&pidsmemheap, StdHeader, IdsNvPtr, NBPtr);
    IdsMemTblDqsTimingDdr3F15St (&pidsmemheap, StdHeader, IdsNvPtr, NBPtr);
 ...
 **/
IDS_STATUS
IdsIntSubMemEnforceMClkAboveNClkSt (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS  *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsPhyDLLStandbyControlBeforeDramInitF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSubGnbORBDynamicWakeF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSubGnbPropertyOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSubGnbPCIePowerGatingOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSubGnbSwTjOffsetOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
  ...
  )
{
  if (IdsEnforcePorMemFreq (DataPtr, StdHeader, IdsNvPtr) == IDS_UNSUPPORTED) {
    ...
    *(PSC_TBL_ENTRY ***) DataPtr = memPSCTblMaxStretchFreqArrayST;
  }
 ...
 */
IDS_STATUS
IdsSubNBPStatesSupportOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
...
/**
 *  IDS Backend Function for ECC Configuration F15 ST
 *
 *
 ...
 **/
IDS_STATUS
IdsIntSubGnbPmmSWDeviceIDRemappingF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSkipSubMSRAccessOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
...
IDS_STATUS
IdsIntSubGnbEqualizationPresetF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
...
IDS_STATUS
IdsIntSubGnbGen1LoopbackOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
 ...
 **/
IDS_STATUS
IdsIntSubGnbSmuPort80ParamsOverrideF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "IdsIntSubGnbSmuPort80ParamsF15St Enter\n");
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "IdsIntSubGnbSmuPort80ParamsF15St Exit\n");
  return IDS_SUCCESS;
}

CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatRdRandBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatWatchdogTimerAndSyncFloodMcaBlockF15St =
{
  IDS_INT_FEAT_WATCHDOG_TIMER,
  IDS_ALL_CORES,
  IDS_CPU_OVERRIDE_REG_AFTER_AP_LAUNCH,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatExceptionBreakpointBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatCoreLevelingBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatNbPsDisOverrideBlockF15St =
{
  IDS_FEAT_POSTPSTATE,
  IDS_ALL_CORES,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntSubNbPstateGetMinFreqBlockF15St =
{
  IDS_FEAT_POSTPSTATE,
  IDS_ALL_CORES,
  IDS_NBPS_MIN_FREQ,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatCpbCtrlBlockF15St =
{
  IDS_FEAT_CPB_CTRL,
  IDS_BSP_ONLY,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatCStateModeBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatConfigIOCstatePostAfterBlockF15St =
{
  IDS_INT_FEAT_CSTATE_MODE,
  IDS_BSP_ONLY,
  IDS_INIT_POST_AFTER,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGetCstBlockF15St =
{
  IDS_INT_FEAT_CSTATE_MODE,
  IDS_ALL_CORES,
  IDS_CST_SIZE,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatCreateCstBlockF15St =
{
  IDS_INT_FEAT_CSTATE_MODE,
  IDS_ALL_CORES,
  IDS_CST_CREATE,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatCacheFlushCtrlBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryInitRegTblBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryTblDrvInitBlockF15St =
{
  IDS_INT_FEAT_MEMORY_TBL_DRV_SUPPORT,
  IDS_ALL_CORES,
  IDS_INIT_DRAM_TABLE,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryOverrideMr0F15St =
{
  IDS_INT_FEAT_MEMORY_TBL_DRV_SUPPORT,
  IDS_ALL_CORES,
  IDS_MEM_MR0,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryPhyPowerSavingF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryEnforceMClkAboveNClkF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatMemoryMappingPostBeforeBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryPhyDllStandbyCtrlBeforeDramInitBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryPhyDllStandbyCtrlBlockF15St =
{
  IDS_INT_FEAT_MEMORY_PHYDLL_STANDBY_CTRL,
  IDS_ALL_CORES,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGNBORBDynamicWakeBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPlatformCfgExBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPropertyOverrideBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPCIePowerGatingOverrideBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbSWTJOFFSETOverrideBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatSkipLockDramCfgF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGetStretchFreqBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatDisableCpuFeatF15St =
{
  IDS_FEAT_COMMON,
  IDS_ALL_CORES,
  IDS_CPU_FEAT,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatNBPStatesSupportBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatCurrentLimitOverrideF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatAPIC330MaskConfigF15St =
{
  IDS_FEAT_COMMON,
  IDS_ALL_CORES,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsIntFeatEccConfigurationF15St =
{
  IDS_FEAT_MEMORY_MAPPING,
  IDS_ALL_CORES,
  IDS_ECC,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPmmSWDeviceIDRemappingF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatSkipMsrAccessOverrideF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatSkipNpstF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPciePhyCfgF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatDsmLpCfgF15St =
{
  IDS_INT_FEAT_DSM_LP,
  IDS_ALL_CORES,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbEqualizationPresetF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbSmuPort80ParamsOverrideF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbGen1LoopbackOverrideF15St =
{
