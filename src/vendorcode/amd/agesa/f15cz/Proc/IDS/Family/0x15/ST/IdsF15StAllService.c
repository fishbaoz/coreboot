...
#define FILECODE PROC_IDS_FAMILY_0X15_ST_IDSF15STALLSERVICE_FILECODE

/**
 *  IDS Backend Function for F15ST workaround
 *
 *
 *  Parameters:
...
/**
 *  IDS Backend Function for Channel Interleave F15 ST
 *
 ...
 **/
IDS_STATUS
IdsIntSubChannelInterleaveF15St (
  IN OUT   VOID *DataPtr,
  IN OUT   AMD_CONFIG_PARAMS *StdHeader,
  IN       IDS_NV_ITEM *IdsNvPtr
  )
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatWorkAroundBlockF15St =
{
  IDS_FEAT_COMMON,
  IDS_ALL_CORES,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryMappingPostBeforeBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatMemoryMappingChIntlvBlockF15St =
{
  IDS_FEAT_MEMORY_MAPPING,
  IDS_ALL_CORES,
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatGnbPlatformCfgBlockF15St =
{
...
CONST IDS_FAMILY_FEAT_STRUCT ROMDATA IdsFeatRegGmmxF15St =
