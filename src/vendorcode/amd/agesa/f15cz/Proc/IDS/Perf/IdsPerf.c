  ...
  )
{
  ...
  PciAddr.AddressValue = MAKE_SBDFO (0, 0, 0x18, FUNC_5, 0x90);
  LibAmdPciRead (AccessWidth32, PciAddr, &GtscLo, StdHeader);
  PciAddr.Address.Register = 0x94;
  LibAmdPciRead (AccessWidth32, PciAddr, &GtscHi, StdHeader);
  ...
  )
{
  ...
  ((TP_Perf_STRUCT *) (LocateHeapStructPtr.BufferPtr)) ->TscInMhz = 100;
