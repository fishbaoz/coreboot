  ...
  )
{
  ...
  for (i = 0; PIdsFeatTbl[i] != NULL; i++) {
    ...
    if (PIdsFeat->IdsOption == IdsOption) {
      ...
      if (No_Check_Bsp || IsBsp (StdHeader)) {
...
/**
 *  IDS Backend Function for All CKE Enable
 *
 *  This function is used to override All CKE Enable
 *
 *  @param[in,out]   DataPtr      The Pointer of AMD_POST_PARAMS.
 *  @param[in,out]   StdHeader    The Pointer of AMD_CONFIG_PARAMS.
 *  @param[in]     IdsNvPtr     The Pointer of NV Table.
  ...
  )
{
  ...
  AllCkeEn = AmdIdsNvReader (AGESA_IDS_NV_ALL_CKE , IdsNvPtr, StdHeader);
  if (AllCkeEn < (IDS_STATUS)0x2) {
    *((UINT8 *) DataPtr) = (UINT8)AllCkeEn;
  }
...
/**
 *  IDS Backend Function for All CS Enable
 *
 *  This function is used to override All CS Enable
 *
 *  @param[in,out]   DataPtr      The Pointer of AMD_POST_PARAMS.
 *  @param[in,out]   StdHeader    The Pointer of AMD_CONFIG_PARAMS.
 *  @param[in]     IdsNvPtr     The Pointer of NV Table.
  ...
  )
{
  ...
  AllCsEn = AmdIdsNvReader (AGESA_IDS_NV_ALL_CS , IdsNvPtr, StdHeader);
  if (AllCsEn < (IDS_STATUS)0x2) {
    *((UINT8 *) DataPtr) = (UINT8)AllCsEn;
  }
