...
#define FILECODE UEFI_FCH_KERN_PEI_FCHPEI_FCHEHCIRECOVERY_FILECODE
  ...
  )
{
  ...
  EnableEhciController (KERN_EHCI1_BUS_DEV_FUN << 16, EhciTemporaryBarAddress, &StdHeader);
  EnableEhciController (KERN_EHCI2_BUS_DEV_FUN << 16, EhciTemporaryBarAddress + 0x400, &StdHeader);
  EnableEhciController (KERN_EHCI3_BUS_DEV_FUN << 16, EhciTemporaryBarAddress + 0x800, &StdHeader);
  return EFI_SUCCESS;
}
