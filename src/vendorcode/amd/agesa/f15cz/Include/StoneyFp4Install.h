 ...
 * @file
 *
 * Install of build options for a Stoney FP4 platform solution
 *
 ...
 * @e project:      AGESA
 * @e sub-project:  Core
 * @e \$Revision: 309403 $   @e \$Date: 2014-12-16 00:18:53 +0800 (Tue, 16 Dec 2014) $
 */
/*****************************************************************************
 *
...
#define AGESA_PACKAGE_STRING  {'S', 't', 'o', 'n', 'e', 'y', 'P', 'I', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '}

                  // This is the release version number of the AGESA component
                  // This string MUST be exactly 12 characters long
#define AGESA_VERSION_STRING  {'V', 'E', '.', '0', '.', '0', '.', '1', 'X', ' ', ' ', ' '}


// The Stoney FP4 solution is defined to be family 0x15 models 0x60 - 0x6F and 0x70 - 0x7F in the FP4 sockets.
#define INSTALL_FP4_SOCKET_SUPPORT           TRUE
#define INSTALL_FAMILY_15_MODEL_6x_SUPPORT   TRUE
#define INSTALL_FAMILY_15_MODEL_7x_SUPPORT   TRUE

#ifdef BLDOPT_REMOVE_FAMILY_15_MODEL_6x_SUPPORT
  #if BLDOPT_REMOVE_FAMILY_15_MODEL_6x_SUPPORT == TRUE
    #undef INSTALL_FAMILY_15_MODEL_6x_SUPPORT
    #define INSTALL_FAMILY_15_MODEL_6x_SUPPORT     FALSE
  #endif
#endif

#ifdef BLDOPT_REMOVE_FAMILY_15_MODEL_7x_SUPPORT
  #if BLDOPT_REMOVE_FAMILY_15_MODEL_7x_SUPPORT == TRUE
    #undef INSTALL_FAMILY_15_MODEL_7x_SUPPORT
    #define INSTALL_FAMILY_15_MODEL_7x_SUPPORT     FALSE
  #endif
#endif
