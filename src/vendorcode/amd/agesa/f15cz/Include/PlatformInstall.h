...
#else
  #define CFG_MEMORY_ENABLE_BANK_SWAP_ONLY      FALSE
#endif
...
#include  "OptionBtcInstall.h"
#include  "OptionApComm.h"
#include  "OptionApCommInstall.h"
...
FCH_PLATFORM_POLICY  FchUserOptions = {
  ...
  (GPIO_CONTROL *) CFG_FCH_GPIO_CONTROL_LIST,            // *CfgFchGpioControl
...
BUILD_OPT_CFG UserOptions = {
  ...
  (UINT32)CFG_CODEC_VERB_TABLE,         // CfgCodecVerbTable
...
CONST DISPATCH_TABLE ROMDATA ApDispatchTable[] =
{
  ...
  { 0, NULL }
      ...
      CONST CHAR8 *BldOptDebugOutput[] = {
          ...
          MAKE_DBG_STR (\nCfgCodecVerbTable             , BLDCFG_CODEC_VERB_TABLE),
          MAKE_DBG_STR (\nCfgGnbAzSsid                  , BLDCFG_GNB_AZ_SSID),
