...
#define F15_CZ_HTC_SUPPORT
          ...
          extern CONST HTC_FAMILY_SERVICES ROMDATA F15CzHtcSupport;
          #undef F15_CZ_HTC_SUPPORT
          #define F15_CZ_HTC_SUPPORT {AMD_FAMILY_15_CZ, &F15CzHtcSupport},
        #endif
      #endif
    #endif
  #endif
