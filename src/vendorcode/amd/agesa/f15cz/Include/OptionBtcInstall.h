 ...
 * @file
 *
 * Install of build option: Boot time calibration.
 *
...
#ifndef _OPTION_BOOTTIME_CALIBRATION_INSTALL_H_
#define _OPTION_BOOTTIME_CALIBRATION_INSTALL_H_
...
CONST CPU_FAMILY_SUPPORT_TABLE ROMDATA BtcFamilyServiceTable =
{
  (sizeof (BtcFamilyServiceArray) / sizeof (CPU_SPECIFIC_SERVICES_XLAT)),
  &BtcFamilyServiceArray[0]
};

#endif  // _OPTION_BOOTTIME_CALIBRATION_INSTALL_H_
