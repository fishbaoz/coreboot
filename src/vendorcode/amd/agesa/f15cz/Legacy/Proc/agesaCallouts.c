...
/*---------------------------------------------------------------------------------------*/
/**
 * Call the host environment interface to launch all APs
 *
  ...
  )
{
  ...
  Status =  AmdAgesaCallout (AGESA_RUNFUNC_ON_ALL_APS, (UINT32)FcnData, (VOID *) LaunchApParams);
...
/*---------------------------------------------------------------------------------------*/
/**
 * Call the host environment interface to idle an AP
 *
 * @param[in]      ApicIdOfCore
 * @param[in]      StdHeader
 *
  ...
  )
{
  ...
  Status =  AmdAgesaCallout (AGESA_IDLE_AN_AP, (UINT32)ApicIdOfCore, (VOID *) StdHeader);
...
/*---------------------------------------------------------------------------------------*/
/**
 * Call the host environment interface to wait for all APs to complete a task
 *
 * @param[in]      FcnData     (unused)
 * @param[in]      StdHeader
 *
  ...
  )
{
  ...
  Status =  AmdAgesaCallout (AGESA_WAIT_FOR_ALL_APS, (UINT32)FcnData, (VOID *) StdHeader);
...
{
   AGESA_STATUS Status;  Status = AmdAgesaCallout(AGESA_FCH_OEM_CALLOUT, (UINT32)FchData, ((FCH_DATA_BLOCK *)FchData)->StdHeader);  return  Status;
