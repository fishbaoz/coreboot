  ...
  )
{
  return TRUE;
  ...
  #if ((AGESA_ENTRY_INIT_RESUME == TRUE) || (AGESA_ENTRY_INIT_S3SAVE == TRUE) || (AGESA_ENTRY_INIT_RTB == TRUE) || (AGESA_ENTRY_INIT_LATE_RESTORE == TRUE) || ((AGESA_ENTRY_INIT_POST) && (OPTION_S3_MEM_SUPPORT == TRUE)))
    ...
    #endif
  #else
    #define MEM_FEATURE_S3_RESUME_CONSTRUCTOR_ML (MEM_RESUME_CONSTRUCTOR *) MemMDefRet
    #define MEM_MAIN_FEATURE_MEM_S3_SAVE MemMDefRet
  #endif
...
/*---------------------------------------------------------------------------------------------------
  ...
  #define PSC_TBL_ML_UDIMM3_S2D_FP4
  #define PSC_TBL_ML_SODIMM3_S2D_FP4
  #if OPTION_MEMCTLR_ML
      ...
      extern PSC_TBL_ENTRY MLSODdr3CSMapCKEEntFT3;
      #define PSC_TBL_ML_CS_MAP_CKE_FT3 &MLSODdr3CSMapCKEEntFT3,
      extern PSC_TBL_ENTRY ML1DOdtPatTblEntFT3;
      #define PSC_TBL_ML_1D_ODT_PAT_FT3 &ML1DOdtPatTblEntFT3,
      extern PSC_TBL_ENTRY ML2DOdtPatTblEntFT3;
      #define PSC_TBL_ML_2D_ODT_PAT_FT3 &ML2DOdtPatTblEntFT3,
      #if OPTION_UDIMMS
      ...
      extern PSC_TBL_ENTRY MLClkDisMapEntSOFP4;
      #define PSC_TBL_ML_CLK_DIS_FP4 &MLClkDisMapEntSOFP4,
      extern PSC_TBL_ENTRY MLSODdr3ODTTriEntFP4;
      #define PSC_TBL_ML_ODT_TRI_FP4 &MLSODdr3ODTTriEntFP4,
      extern PSC_TBL_ENTRY MLSODdr3CSTriEntFP4;
      #define PSC_TBL_ML_CS_TRI_FP4 &MLSODdr3CSTriEntFP4,
      extern PSC_TBL_ENTRY MLSODdr3CSMapCKEEntFP4;
      #define PSC_TBL_ML_CS_MAP_CKE_FP4 &MLSODdr3CSMapCKEEntFP4,
      extern PSC_TBL_ENTRY ML1DOdtPatTblEntFP4;
      #define PSC_TBL_ML_1D_ODT_PAT_FP4 &ML1DOdtPatTblEntFP4,
      extern PSC_TBL_ENTRY ML2DOdtPatTblEntFP4;
      #define PSC_TBL_ML_2D_ODT_PAT_FP4 &ML2DOdtPatTblEntFP4,
      #if OPTION_UDIMMS
        extern PSC_TBL_ENTRY MLMaxFreqTblEntU6L;
        #define PSC_TBL_ML_UDIMM3_MAX_FREQ_6L  &MLMaxFreqTblEntU6L,
        extern PSC_TBL_ENTRY MLMaxFreqTblEntU4L;
        ...
        extern PSC_TBL_ENTRY MLSAOTblEntU3;
        #define PSC_TBL_ML_UDIMM3_SAO  &MLSAOTblEntU3,
        #undef PSC_TBL_ML_UDIMM3_S2D_FP4
        extern PSC_TBL_ENTRY MLS2DTblEntUFP4;
        #define PSC_TBL_ML_UDIMM3_S2D_FP4  &MLS2DTblEntUFP4,
      #endif
      #if OPTION_SODIMMS
        #if OPTION_FP4_SOCKET_SUPPORT
          extern PSC_TBL_ENTRY MLSAOTblEntSO3;
          ...
          extern PSC_TBL_ENTRY MLMaxFreqTblEntSoDwnLPM;
          #define PSC_TBL_ML_SODWN_MAX_FREQ_LPM  &MLMaxFreqTblEntSoDwnLPM,
          #undef PSC_TBL_ML_SODIMM3_S2D_FP4
          extern PSC_TBL_ENTRY MLS2DTblEntUFP4;
          #define PSC_TBL_ML_SODIMM3_S2D_FP4 &MLS2DTblEntUFP4,
        #endif
      #endif
    #endif
    ...
    #endif
    #ifndef PSC_TBL_ML_CLK_DIS_FP4
      #define PSC_TBL_ML_CLK_DIS_FP4
    #endif
    #ifndef PSC_TBL_ML_ODT_TRI_FP4
      #define PSC_TBL_ML_ODT_TRI_FP4
    #endif
    #ifndef PSC_TBL_ML_CS_TRI_FP4
      #define PSC_TBL_ML_CS_TRI_FP4
    #endif
    #ifndef PSC_TBL_ML_CS_MAP_CKE_FT3
      #define PSC_TBL_ML_CS_MAP_CKE_FT3
    #endif
    #ifndef PSC_TBL_ML_CS_MAP_CKE_FP4
      #define PSC_TBL_ML_CS_MAP_CKE_FP4
    #endif
    #ifndef PSC_TBL_ML_1D_ODT_PAT_FT3
      #define PSC_TBL_ML_1D_ODT_PAT_FT3
    #endif
    #ifndef PSC_TBL_ML_2D_ODT_PAT_FT3
      #define PSC_TBL_ML_2D_ODT_PAT_FT3
    #endif
    #ifndef PSC_TBL_ML_1D_ODT_PAT_FP4
      #define PSC_TBL_ML_1D_ODT_PAT_FP4
    #endif
    #ifndef PSC_TBL_ML_2D_ODT_PAT_FP4
      #define PSC_TBL_ML_2D_ODT_PAT_FP4
    #endif
    ...
    PSC_TBL_ENTRY* memPSCTblODTPatArrayML[] = {
      PSC_TBL_ML_1D_ODT_PAT_FT3
      PSC_TBL_ML_2D_ODT_PAT_FT3
      PSC_TBL_ML_1D_ODT_PAT_FP4
      PSC_TBL_ML_2D_ODT_PAT_FP4
      PSC_TBL_END
    };
    ...
    PSC_TBL_ENTRY* memPSCTblGenArrayML[] = {
      ...
      PSC_TBL_ML_CS_MAP_CKE_FT3
      PSC_TBL_ML_CLK_DIS_FP4
      PSC_TBL_ML_ODT_TRI_FP4
      PSC_TBL_ML_CS_TRI_FP4
      PSC_TBL_ML_CS_MAP_CKE_FP4
      PSC_TBL_END
    };
    ...
    PSC_TBL_ENTRY* memPSCTblS2DArrayML[] = {
      ...
      PSC_TBL_ML_UDIMM3_S2D_FP4
      PSC_TBL_ML_SODIMM3_S2D_FP4
      PSC_TBL_END
    };
