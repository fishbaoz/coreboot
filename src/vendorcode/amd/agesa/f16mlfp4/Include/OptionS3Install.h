...
#define CFG_S3SAVE_ENTRY                (PF_S3SAVE_ENTRY) CommonReturnAgesaSuccess
  ...
  #if (AGESA_ENTRY_INIT_RTB == TRUE) || (AGESA_ENTRY_INIT_S3SAVE == TRUE)
    extern F_S3SAVE_ENTRY AmdS3SaveAtRtb;
    extern F_S3SAVE_CONSTRUCTOR AmdS3SaveInitializerCommon;
    extern F_S3SAVE_DESTRUCTOR  AmdS3SaveDestructorCommon;

    #undef CFG_S3SAVE_CONSTRUCTOR
    #define CFG_S3SAVE_CONSTRUCTOR          (PF_S3SAVE_CONSTRUCTOR) AmdS3SaveInitializerCommon
    #undef CFG_S3SAVE_DESTRUCTOR
    #define CFG_S3SAVE_DESTRUCTOR           (PF_S3SAVE_DESTRUCTOR) AmdS3SaveDestructorCommon
    #undef CFG_S3SAVE_ENTRY
    #define CFG_S3SAVE_ENTRY                (PF_S3SAVE_ENTRY) AmdS3SaveAtRtb
  #endif
#else
  #undef AGESA_ENTRY_INIT_S3SAVE
