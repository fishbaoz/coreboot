...
typedef enum {
  ...
  AMD_INIT_RTB_HANDLE,                            ///< Assign 0x000A037 buffer handle to AmdInitRtb routine.
  AMD_CS_RESTORATION_HANDLE,                      ///< Assign 0x000A038 buffer handle for connected standby restoration
