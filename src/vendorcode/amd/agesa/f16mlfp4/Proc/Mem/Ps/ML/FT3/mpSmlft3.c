...
// CSMapCKE
//
STATIC CONST UINT32 ROMDATA MLSODdr3CSMapCKEFT3[] = {0x08040201};
CONST PSC_TBL_ENTRY MLSODdr3CSMapCKEEntFT3 = {
   {PSCFG_CSMAPCKE, SODIMM_TYPE + UDIMM_TYPE, _1DIMM + _2DIMM, {AMD_FAMILY_16_ML, AMD_F16_ALL}, SOCKET_FT3_ML, DDR3_TECHNOLOGY},
   sizeof (MLSODdr3CSMapCKEFT3) / sizeof (UINT32),
   (VOID *)&MLSODdr3CSMapCKEFT3
};
...
//
STATIC CONST PSCFG_1D_ODTPAT_ENTRY ML1DOdtPatFT3[] = {
  {DIMM_SR, 0x00000000, 0x00000000, 0x00000000, 0x00000001},
  {DIMM_DR, 0x00000000, 0x00000000, 0x00000000, 0x00000201},
};
CONST PSC_TBL_ENTRY ML1DOdtPatTblEntFT3 = {
   {PSCFG_ODT_PAT_1D, DT_DONT_CARE, _1DIMM, {AMD_FAMILY_16_ML, AMD_F16_ALL}, SOCKET_FT3_ML, DDR3_TECHNOLOGY},
   sizeof (ML1DOdtPatFT3) / sizeof (PSCFG_1D_ODTPAT_ENTRY),
   (VOID *)&ML1DOdtPatFT3
};
...
//
STATIC CONST PSCFG_2D_ODTPAT_ENTRY ML2DOdtPatFT3[] = {
...
CONST PSC_TBL_ENTRY ML2DOdtPatTblEntFT3 = {
   {PSCFG_ODT_PAT_2D, DT_DONT_CARE, _2DIMM, {AMD_FAMILY_16_ML, AMD_F16_ALL}, SOCKET_FT3_ML, DDR3_TECHNOLOGY},
   sizeof (ML2DOdtPatFT3) / sizeof (PSCFG_2D_ODTPAT_ENTRY),
   (VOID *)&ML2DOdtPatFT3
};